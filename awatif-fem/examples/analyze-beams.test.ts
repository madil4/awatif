...
describe("analyze beams", () => {
  ...
  describe("distributed forces", () => {
    test("compute deformations and forces of Logan's book example 4.6", () => {
      const L = 5;
      const wY = -4;
      const wZ = -4;
      const E = 3;
      ...
      expect(analysisOutputs).toEqual({
        default: [
          { node: 0, deformation: [0, 0, 0, 0, 0, 0] },
          {
            node: 0,
            reaction: [
              0, 19.999999999999996, 19.999999999999996, 0, -49.999999999999986,
              49.999999999999986,
            ],
          },
          {
            node: 1,
            deformation: [
              0, -14.880952380952376, -14.880952380952376, 0,
              3.9682539682539666, -3.9682539682539666,
            ],
          },
          {
            element: 0,
            normal: [0, 0],
            shearY: [19.999999999999996, 3.552713678800501e-15],
            shearZ: [19.999999999999996, 3.552713678800501e-15],
            torsion: [0, 0],
            bendingY: [-49.999999999999986, 5.329070518200751e-15],
            bendingZ: [49.999999999999986, -5.329070518200751e-15],
          },
        ],
      });
    });

    test("compute deformations and forces of Logan's book example 4.8", () => {
      const L = 5;
      const wY = -4;
      const P = 3;
      const E = 3;
      ...
      expect(analysisOutputs).toEqual({
        default: [
          ...
          {
            node: 1,
            deformation: [0, -20.833333333333325, 0, 0, 0, -5.753968253968251],
          },
          {
            element: 0,
            normal: [0, 0],
            ...
            torsion: [0, 0],
            bendingY: [0, 0],
            bendingZ: [64.99999999999997, -5.329070518200751e-15],
          },
        ],
      });
    });
