...
#define LOW_PRECISION`),t}function n0(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===ah?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===dp?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Cn&&(t="SHADOWMAP_TYPE_VSM"),t}function i0(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case fr:case mr:t="ENVMAP_TYPE_CUBE";break;case go:t="ENVMAP_TYPE_CUBE_UV";break}return t}function r0(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case mr:t="ENVMAP_MODE_REFRACTION";break}return t}function s0(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case lh:t="ENVMAP_BLENDING_MULTIPLY";break;case Op:t="ENVMAP_BLENDING_MIX";break;case Fp:t="ENVMAP_BLENDING_ADD";break}return t}function o0(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function a0(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=n0(e),c=i0(e),u=r0(e),h=s0(e),d=o0(e),m=e.isWebGL2?"":Yg(e),v=jg(e),x=Kg(s),f=r.createProgram();let p,E,_=e.glslVersion?"#version "+e.glslVersion+`
