...
export function Line(props: LineProps) {
  ...
  const swapStartYZ = [props.start[0], props.start[2], props.start[1]];
  const swapEndYZ = [props.end[0], props.end[2], props.end[1]];

  line.geometry.setPositions([...swapStartYZ, ...swapEndYZ]);
