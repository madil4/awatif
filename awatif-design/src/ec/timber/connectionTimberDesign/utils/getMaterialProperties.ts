...
export function getTimberProperties(
  grade: string
): [
  string,
  number,
  ...
  const LRhok: number[] = [
    355, 355, 365, 385, 390, 390, 400, 340, 370, 385, 405, 425, 430, 440,
  ];
  const LFmk: number[] = [
    20, 22, 24, 26, 28, 30, 32, 20, 22, 24, 26, 28, 30, 32,
  ];
  const LFT0k: number[] = [
    15, 16, 17, 19, 19.5, 19.5, 19.5, 16, 17.6, 19.2, 20.8, 22.3, 24, 25.6,
  ];
  const LFT90k: number[] = [
    0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5,
  ];
  const LFC0k: number[] = [
    18.5, 20, 21.5, 23.5, 24, 24.5, 24.5, 20, 22, 24, 26, 28, 30, 32,
  ];
  const LFC90k: number[] = [
  ...
  const LE0mean: number[] = [
    10400, 10400, 11000, 12000, 12500, 13000, 13500, 8400, 10500, 11500, 12100,
    12600, 13600, 14200,
  ];
  const LE05: number[] = [
    8600, 8600, 9100, 10000, 10400, 10800, 11200, 7000, 8800, 9860, 10100,
    10500, 11300, 11800,
  ];
  const LG05: number[] = [
