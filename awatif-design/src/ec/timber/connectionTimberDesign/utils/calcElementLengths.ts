import {
 ...
 export function calculateElementLength(elements: Element[], nodes: Node[]): number[] {
  ...
  export function calculateElementLengthSingle(element: Element, nodes: Node[]): number {
