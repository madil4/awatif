...
import { g as T, __tla as __tla_0 } from "./getMesh-2YQ5nkGL.js";
import { n as H, s as N } from "./pureFunctionsAny.generated-Dh3LO6N2.js";
...
Promise.all([
  ...
  class j {
    ...
    setColorMap(t, e = 32) {
      this.map = g[t] || g.rainbow, this.n = e;
  ...
  }, x = u.state([]), F = u.state([]), b = u.state([]), f = u.state([]);
  u.derive(() => {
    const o = [
      M.boundary.value.val,
      0,
      3
    ...
    x.val = t, F.val = e, f.val = P(o, x.val), b.val = [
      G(x.val, F.val, f.val)
    ];
  });
  document.body.append(L(M), S({
    mesh: {
      nodes: x,
      elements: F
    },
