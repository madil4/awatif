import { _ as be, t as pe, D as st, C as wr } from "./complex-i8qiIvCl.js";
var sn = { relTol: 1e-12, absTol: 1e-15, matrix: "Matrix", number: "number", numberFallback: "number", precision: 64, predictable: false, randomSeed: null };
function Kn(r, e) {
  if (de(r, e)) return r[e];
  throw typeof r[e] == "function" && kn(r, e) ? new Error('Cannot access method "' + e + '" as a property') : new Error('No access to property "' + e + '"');
}
function Hn(r, e, n) {
...
function de(r, e) {
  return !jn(r) && !Array.isArray(r) ? false : ne(ru, e) ? true : !(e in Object.prototype || e in Function.prototype);
}
function kn(r, e) {
  return r == null || typeof r[e] != "function" || ne(r, e) && Object.getPrototypeOf && e in Object.getPrototypeOf(r) ? false : ne(eu, e) ? true : !(e in Object.prototype || e in Function.prototype);
}
function jn(r) {
  return typeof r == "object" && r && r.constructor === Object;
}
var ru = { length: true, name: true }, eu = { toString: true, valueOf: true, toLocaleString: true };
class tu {
  constructor(e) {
  ...
  set(e, n) {
    return Hn(this.wrappedObject, e, n), this;
  }
  has(e) {
    return de(this.wrappedObject, e) && e in this.wrappedObject;
  }
  entries() {
    return nu(this.keys(), (e) => [e, this.get(e)]);
  }
  forEach(e) {
...
function $r(r) {
  var e = typeof r;
  return e === "object" ? r === null ? "null" : Fr(r) ? "BigNumber" : r.constructor && r.constructor.name ? r.constructor.name : "Object" : e;
}
function ur(r) {
  var e = typeof r;
...
var Ou = ["Matrix", "Array"], $u = ["number", "BigNumber", "Fraction"], br = function(e) {
...
`);
  return Object.freeze(sn);
};
be(br, sn, { MATRIX_OPTIONS: Ou, NUMBER_OPTIONS: $u });
function Z(r, e, n, u) {
  function t(a) {
    var s = zu(a, e.map(Ru));
    return Iu(r, e, a), n(s);
...
function qe(r, e) {
  ...
  var { notation: n, precision: u, wordSize: t } = Dn(e);
  switch (n) {
    case "fixed":
      return Lu(r, u);
    case "exponential":
    ...
    case "hex":
      return $e(r, 16, t);
    case "auto":
      return Vu(r, u, e).replace(/((\.\d*?)(0+))($|e)/, function() {
...
function Dn(r) {
  var e = "auto", n, u;
  if (r !== void 0) if (cr(r)) n = r;
  else if (Fr(r)) n = r.toNumber();
  else if (Qe(r)) r.precision !== void 0 && (n = ft(r.precision, () => {
    throw new Error('Option "precision" must be a number or BigNumber');
  })), r.wordSize !== void 0 && (u = ft(r.wordSize, () => {
...
function Pu(r, e) {
  ...
  if (cr(e)) for (; e > a.length || t - s + 1 > a.length; ) a.push(0);
  else for (var D = Math.abs(t - s) - (a.length - 1), f = 0; f < D; f++) a.push(0);
  for (var c = Math.abs(t - s), o = 1; c > 0; ) o++, c--;
  var l = a.slice(o).join(""), m = cr(e) && l.length || l.match(/[1-9]/) ? "." + l : "", v = a.slice(0, o).join("") + m + "e" + (t >= 0 ? "+" : "") + s.toString();
  return u.sign + v;
}
function Lu(r, e) {
  if (isNaN(r) || !isFinite(r)) return String(r);
  var n = _e(r), u = typeof e == "number" ? Be(n, n.exponent + 1 + e) : n, t = u.coefficients, a = u.exponent + 1, s = a + (e || 0);
  return t.length < s && (t = t.concat(Yr(s - t.length))), a < 0 && (t = Yr(-a + 1).concat(t), a = 1), a < t.length && t.splice(a, 0, a === 0 ? "0." : "."), u.sign + t.join("");
}
function pn(r, e) {
  if (isNaN(r) || !isFinite(r)) return String(r);
  var n = _e(r), u = e ? Be(n, e) : n, t = u.coefficients, a = u.exponent;
  t.length < e && (t = t.concat(Yr(e - t.length)));
  var s = t.shift();
  return u.sign + s + (t.length > 0 ? "." + t.join("") : "") + "e" + (a >= 0 ? "+" : "") + a;
}
function Vu(r, e, n) {
  if (isNaN(r) || !isFinite(r)) return String(r);
  var u = lt(n == null ? void 0 : n.lowerExp, -3), t = lt(n == null ? void 0 : n.upperExp, 5), a = _e(r), s = e ? Be(a, e) : a;
  if (s.exponent < u || s.exponent >= t) return pn(r, e);
  var D = s.coefficients, f = s.exponent;
  D.length < e && (D = D.concat(Yr(e - D.length))), D = D.concat(Yr(f - D.length + 1 + (D.length < e ? e - D.length : 0))), D = Yr(-f).concat(D);
  var c = f > 0 ? f : 0;
...
function ft(r, e) {
  if (cr(r)) return r;
  if (Fr(r)) return r.toNumber();
  e();
}
function lt(r, e) {
  return cr(r) ? r : Fr(r) ? r.toNumber() : e;
}
var dn = function() {
  return dn = pe.create, pe;
}, Zu = ["?BigNumber", "?Complex", "?DenseMatrix", "?Fraction"], Ju = Z("typed", Zu, function(e) {
  var { BigNumber: n, Complex: u, DenseMatrix: t, Fraction: a } = e, s = dn();
  return s.clear(), s.addTypes([{ name: "number", test: cr }, { name: "Complex", test: We }, { name: "BigNumber", test: Fr }, { name: "bigint", test: uu }, { name: "Fraction", test: Ze }, { name: "Unit", test: fn }, { name: "identifier", test: (D) => Or && /^(?:[A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088E\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDD\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7CD\uA7D0\uA7D1\uA7D3\uA7D5-\uA7DC\uA7F2-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC4\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD887][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD08]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF39\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD888[\uDC00-\uDFAF])(?:[0-9A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088E\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDD\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7CD\uA7D0\uA7D1\uA7D3\uA7D5-\uA7DC\uA7F2-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC4\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD887][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD08]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF39\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD888[\uDC00-\uDFAF])*$/.test(D) }, { name: "string", test: Or }, { name: "Chain", test: Mu }, { name: "Array", test: mr }, { name: "Matrix", test: fr }, { name: "DenseMatrix", test: ln }, { name: "SparseMatrix", test: cn }, { name: "Range", test: vn }, { name: "Index", test: Je }, { name: "boolean", test: au }, { name: "ResultSet", test: iu }, { name: "Help", test: ou }, { name: "function", test: su }, { name: "Date", test: fu }, { name: "RegExp", test: lu }, { name: "null", test: vu }, { name: "undefined", test: Du }, { name: "AccessorNode", test: pu }, { name: "ArrayNode", test: du }, { name: "AssignmentNode", test: hu }, { name: "BlockNode", test: mu }, { name: "ConditionalNode", test: gu }, { name: "ConstantNode", test: yu }, { name: "FunctionNode", test: Au }, { name: "FunctionAssignmentNode", test: Fu }, { name: "IndexNode", test: Eu }, { name: "Node", test: Cu }, { name: "ObjectNode", test: wu }, { name: "OperatorNode", test: bu }, { name: "ParenthesisNode", test: _u }, { name: "RangeNode", test: Bu }, { name: "RelationalNode", test: xu }, { name: "SymbolNode", test: Su }, { name: "Map", test: cu }, { name: "Object", test: Qe }]), s.addConversions([{ from: "number", to: "BigNumber", convert: function(f) {
    if (n || ce(f), Wu(f) > 15) throw new TypeError("Cannot implicitly convert a number with >15 significant digits to BigNumber (value: " + f + "). Use function bignumber(x) to convert to BigNumber.");
    return new n(f);
...
var Xu = "BigNumber", Gu = ["?on", "config"], Yu = Z(Xu, Gu, (r) => {
  var { on: e, config: n } = r, u = st.clone({ precision: n.precision, modulo: st.EUCLID });
...
}, { isClass: true }), Ku = "Complex", Hu = [], ku = Z(Ku, Hu, () => (Object.defineProperty(wr, "name", { value: "Complex" }), wr.prototype.constructor = wr, wr.prototype.type = "Complex", wr.prototype.isComplex = true, wr.prototype.toJSON = function() {
  ...
  var e = "", n = this.im, u = this.re, t = qe(this.re, r), a = qe(this.im, r), s = cr(r) ? r : r ? r.precision : null;
  if (s !== null) {
    var D = Math.pow(10, -s);
  ...
  switch (arguments.length) {
    ...
    case 2: {
      ...
      if (cr(n)) {
        if (fn(u) && u.hasBase("ANGLE") && (u = u.toNumber("rad")), cr(u)) return new wr({ r: n, phi: u });
...
const H = BigInt(0), rr = BigInt(1), ue = BigInt(2), Re = BigInt(5), _r = BigInt(10), ju = 2e3, X = { s: rr, n: H, d: rr };
function qr(r, e) {
  try {
    r = BigInt(r);
  } catch {
...
const Er = function(r, e) {
  ...
  if (r != null) if (e !== void 0) {
    ...
    if (l === null) throw Lr();
    if (l[a] === "-" ? (t = -rr, a++) : l[a] === "+" && a++, l.length === a + 1 ? D = qr(l[a++], t) : l[a + 1] === "." || l[a] === "." ? (l[a] !== "." && (s = qr(l[a++], t)), a++, (a + 1 === l.length || l[a + 1] === "(" && l[a + 3] === ")" || l[a + 1] === "'" && l[a + 3] === "'") && (D = qr(l[a], t), c = _r ** BigInt(l[a].length), a++), (l[a] === "(" && l[a + 2] === ")" || l[a] === "'" && l[a + 2] === "'") && (f = qr(l[a + 1], t), o = _r ** BigInt(l[a + 1].length) - rr, a += 3)) : l[a + 1] === "/" || l[a + 1] === ":" ? (D = qr(l[a], t), c = qr(l[a + 2], rr), a += 3) : l[a + 3] === "/" && l[a + 1] === " " && (s = qr(l[a], t), D = qr(l[a + 2], t), c = qr(l[a + 4], rr), a += 5), l.length <= a) u = c * o, t = n = f + u * s + o * D;
    else throw Lr();
...
function ea(r, e) {
  ...
  if (e === rr) return H;
  let n = _r % e, u = 1;
  for (; n !== rr; u++) if (n = n * _r % e, u > ju) return H;
  return BigInt(u);
}
function ta(r, e, n) {
  let u = rr, t = ra(_r, n, e);
  for (let a = 0; a < 300; a++) {
...
Tr.prototype = { s: rr, n: H, d: rr, abs: function() {
  ...
  let n = Gr(this.n), u = Gr(this.d), t = rr, a = rr;
  ...
  const n = {}, u = Gr(X.n), t = Gr(X.d), a = Gr(this.n), s = Gr(this.d);
  ...
  r = r || 15;
  let u = ea(e, n), t = ta(e, n, u), a = this.s < H ? "-" : "";
...
var na = "Fraction", ua = [], aa = Z(na, ua, () => (Object.defineProperty(Tr, "name", { value: "Fraction" }), Tr.prototype.constructor = Tr, Tr.prototype.type = "Fraction", Tr.prototype.isFraction = true, Tr.prototype.toJSON = function() {
  return { mathjs: "Fraction", n: String(this.s * this.n), d: String(this.d) };
}, Tr.fromJSON = function(r) {
  return new Tr(r);
}, Tr), { isClass: true }), ia = "Matrix", oa = [], sa = Z(ia, oa, () => {
  function r() {
...
function fa(r, e) {
  ...
  switch (n) {
    ...
    case "auto": {
      ...
      return c >= a && c < s ? D = f.toFixed() : D = vt(r, u), D.replace(/((\.\d*?)(0+))($|e)/, function() {
...
function va(r, e) {
  ...
  if (Fr(r)) return fa(r, e);
  if (Da(r)) return !e || e.fraction !== "decimal" ? "".concat(r.s * r.n, "/").concat(r.d) : r.toString();
  if (Array.isArray(r)) return hn(r, e);
  if (Or(r)) return pt(r);
  ...
  if (r && typeof r == "object") {
    ...
    var n = Object.keys(r).map((u) => pt(u) + ": " + dr(r[u], e));
    return "{" + n.join(", ") + "}";
  }
  return String(r);
}
...
function hn(r, e) {
  if (Array.isArray(r)) {
    for (var n = "[", u = r.length, t = 0; t < u; t++) t !== 0 && (n += ", "), n += hn(r[t], e);
    return n += "]", n;
  } else return dr(r, e);
}
function Da(r) {
...
function yr(r, e) {
  if (r !== void 0) {
    if (!cr(r) || !pr(r)) throw new TypeError("Index must be an integer (value: " + r + ")");
...
function me(r, e, n) {
  ...
  e.forEach(function(t) {
    if (!cr(t) || !pr(t) || t < 0) throw new TypeError("Invalid size, must contain positive integers (size: " + dr(e) + ")");
  }), (cr(r) || Fr(r)) && (r = [r]);
  var u = n !== void 0 ? n : 0;
  return Ue(r, e, 0, u), r;
}
...
function Ye(r, e) {
  var n = gn(r), u = r.slice(), t = -1, a = r.indexOf(t), s = r.indexOf(t, a + 1) >= 0;
...
function mt(r, e) {
  ...
  return u < n.length && (r = yn(r, u, 0), n.length = u), r;
}
function yn(r, e, n) {
  var u, t;
  if (n < e) {
    var a = n + 1;
    for (u = 0, t = r.length; u < t; u++) r[u] = yn(r[u], e, a);
...
function Fn(r, e, n, u) {
  ...
  for (r = An(r, e, 0); t.length < e; ) t.push(1);
  return r;
}
function An(r, e, n) {
  var u, t;
  if (Array.isArray(r)) {
    var a = n + 1;
    for (u = 0, t = r.length; u < t; u++) r[u] = An(r[u], e, a);
...
function En(r, e, n, u) {
  if (u < n) {
    ...
    for (var t = [], a = 0; a < r.length; a++) t[a] = En(r[a], e[a], n, u + 1);
    return t;
...
function wn() {
  ...
  for (var l = 0; l < e.length; l++) bn(e[l], a);
  return a;
}
function bn(r, e) {
...
function Le(r, e) {
  ...
  if (Vr(n, e)) return r;
  bn(n, e);
  var u = wn(n, e), t = u.length, a = [...Array(t - n.length).fill(1), ...n], s = ha(r);
  n.length < t && (s = Ge(s, a), n = sr(s));
  for (var D = 0; D < t; D++) n[D] < u[D] && (s = da(s, u[D], D), n = sr(s));
  return s;
}
function da(r, e, n) {
  return Cn(...Array(e).fill(r), n);
}
function _n(r, e) {
...
function ge(r, e, n) {
  ...
  if (pe.isTypedFunction(r)) {
    ...
    if (u) t = 1;
      ...
      var a = (e.isMatrix ? e.size() : sr(e)).map(() => 0), s = e.isMatrix ? e.get(a) : _n(e, a);
      t = ya(r, s, a, e);
    }
    var D;
    ...
    return t >= 1 && t <= 3 ? { isUnary: t === 1, fn: function() {
      ...
      return yt(D, l.slice(0, t), n, r.name);
    } } : { isUnary: false, fn: function() {
      for (var o = arguments.length, l = new Array(o), m = 0; m < o; m++) l[m] = arguments[m];
      return yt(D, l, n, r.name);
    } };
  }
  return u === void 0 ? { isUnary: ga(r), fn: r } : { isUnary: u, fn: r };
}
function ma(r, e) {
  var n = [];
...
var Aa = "DenseMatrix", Ea = ["Matrix"], Ca = Z(Aa, Ea, (r) => {
  var { Matrix: e } = r;
  function n(o, l) {
    ...
    else if (o && mr(o.data) && mr(o.size)) this._data = o.data, this._size = o.size, ht(this._data, this._size), this._datatype = l || o.datatype;
    else if (mr(o)) this._data = c(o), this._size = sr(this._data), ht(this._data, this._size), this._datatype = l;
    else {
  ...
  n.prototype.clone = function() {
    ...
    if (o) {
      if (Fr(o) && (o = o.toNumber()), !cr(o) || !pr(o)) throw new TypeError("The parameter k must be an integer number");
    } else o = 0;
    ...
    if (o = o.map(function(b) {
      if (Fr(b) && (b = b.toNumber()), !cr(b) || !pr(b) || b < 1) throw new Error("Size values must be positive integers");
      return b;
    }), m) {
      if (Fr(m) && (m = m.toNumber()), !cr(m) || !pr(m)) throw new TypeError("The parameter k must be an integer number");
    } else m = 0;
    ...
    v || (v = Fr(y(0)) ? y(0).mul(0) : 0);
    var A = [];
    if (o.length > 0) {
      A = me(A, o, v);
      for (var F = 0; F < C; F++) A[F + i][F + p] = y(F);
    }
    return new n({ data: A, size: [d, h] });
  }, n.fromJSON = function(o) {
    return new n(o);
  }, n.prototype.swapRows = function(o, l) {
    if (!cr(o) || !pr(o) || !cr(l) || !pr(l)) throw new Error("Row index must be positive integers");
...
function Mr(r, e, n) {
  if (!n) return fr(r) ? r.map((t) => e(t), false, true) : gt(r, e, true);
  var u = (t) => t === 0 ? t : e(t);
  return fr(r) ? r.map((t) => u(t), false, true) : gt(r, u, true);
}
var Ft = "isInteger", wa = ["typed"], ba = Z(Ft, wa, (r) => {
  var { typed: e } = r;
  return e(Ft, { number: pr, BigNumber: function(u) {
    return u.isInt();
  }, bigint: function(u) {
    return true;
  }, Fraction: function(u) {
...
var At = "isPositive", Ba = ["typed", "config"], xa = Z(At, Ba, (r) => {
  var { typed: e, config: n } = r;
  return e(At, { number: (u) => Rr(u, 0, n.relTol, n.absTol) ? false : zn(u), BigNumber: (u) => Kr(u, new u.constructor(0), n.relTol, n.absTol) ? false : !u.isNeg() && !u.isZero() && !u.isNaN(), bigint: (u) => u > 0n, Fraction: (u) => u.s > 0n && u.n > 0n, Unit: e.referToSelf((u) => (t) => e.find(u, t.valueType())(t.value)), "Array | Matrix": e.referToSelf((u) => (t) => Mr(t, u)) });
}), Et = "isZero", Sa = ["typed", "equalScalar"], Ma = Z(Et, Sa, (r) => {
  var { typed: e, equalScalar: n } = r;
  return e(Et, { "number | BigNumber | Complex | Fraction": (u) => n(u, 0), bigint: (u) => u === 0n, Unit: e.referToSelf((u) => (t) => e.find(u, t.valueType())(t.value)), "Array | Matrix": e.referToSelf((u) => (t) => Mr(t, u)) });
});
function Na(r, e, n, u) {
  return Rr(r.re, e.re, n, u) && Rr(r.im, e.im, n, u);
}
var ae = Z("compareUnits", ["typed"], (r) => {
  ...
  return e(ye, { "boolean, boolean": function(a, s) {
    ...
    return Na(a, s, n.relTol, n.absTol);
  } }, u);
});
Z(ye, ["typed", "config"], (r) => {
  var { typed: e, config: n } = r;
  return e(ye, { "number, number": function(t, a) {
    return Rr(t, a, n.relTol, n.absTol);
  } });
});
var Oa = "SparseMatrix", $a = ["typed", "equalScalar", "Matrix"], Ia = Z(Oa, $a, (r) => {
  ...
  function s(i, d, h) {
    ...
    var C = d.length, y = 0, w = n, A = 0;
    if (Or(h) && (w = e.find(n, [h, h]) || n, A = e.convert(0, h)), C > 0) {
      var F = 0;
      do {
        ...
        for (var b = 0; b < C; b++) {
          var E = d[b];
          if (mr(E)) {
            if (F === 0 && y < E.length && (y = E.length), F < E.length) {
              var g = E[F];
              w(g, A) || (i._values.push(g), i._index.push(b));
            }
          } else F === 0 && y < 1 && (y = 1), w(E, A) || (i._values.push(E), i._index.push(b));
        }
        F++;
      } while (F < y);
    }
  ...
  function D(i, d) {
    ...
    return N.forEach(function($) {
      for (T.push(R.length), A = _[$], F = _[$ + 1]; A < F; A++) y = B[A], S[y] === true && (R.push(O[y]), M && M.push(g[A]));
  ...
  function f(i, d, h, C) {
    ...
    var y = d.size(), w = d.isScalar(), A;
    if (fr(h) ? (A = h.size(), h = h.toArray()) : A = sr(h), w) {
      ...
      if (A.length < y.length) {
        for (var F = 0, b = 0; y[F] === 1 && A[F] === 1; ) F++;
        for (; y[F] === 1; ) b++, F++;
        h = Fn(h, y.length, b, A);
      }
      if (!Vr(y, A)) throw new ar(y, A, ">");
      if (y.length === 1) {
        var E = d.dimension(0);
  ...
  t.prototype.get = function(i) {
    ...
    var C = i[0], y = i[1], w = this._size[0], A = this._size[1], F = n, b = 0;
    Or(this._datatype) && (F = e.find(n, [this._datatype, this._datatype]) || n, b = e.convert(0, this._datatype)), (C > w - 1 || y > A - 1) && (m(this, Math.max(C + 1, w), Math.max(y + 1, A), h), w = this._size[0], A = this._size[1]), yr(C, w), yr(y, A);
    var E = c(C, this._ptr[y], this._ptr[y + 1], this._index);
    return E < this._ptr[y + 1] && this._index[E] === C ? F(d, b) ? o(E, y, this._values, this._index, this._ptr) : this._values[E] = d : F(d, b) || l(E, C, y, d, this._values, this._index, this._ptr), this;
  };
  function c(i, d, h, C) {
    if (h - d === 0) return h;
  ...
  function l(i, d, h, C, y, w, A) {
    y.splice(i, 0, C), w.splice(i, 0, d);
    for (var F = h + 1; F < A.length; F++) A[F]++;
  }
  t.prototype.resize = function(i, d, h) {
    ...
    C.forEach(function(w) {
      if (!cr(w) || !pr(w) || w < 0) throw new TypeError("Invalid size, must contain positive integers (size: " + dr(C) + ")");
    });
  ...
  function m(i, d, h, C) {
    var y = C || 0, w = n, A = 0;
    Or(i._datatype) && (w = e.find(n, [i._datatype, i._datatype]) || n, A = e.convert(0, i._datatype), y = e.convert(y, i._datatype));
    var F = !w(y, A), b = i._size[0], E = i._size[1], g, B, _;
    if (h > E) {
      for (B = E; B < h; B++) if (i._ptr[B] = i._values.length, F) for (g = 0; g < b; g++) i._values.push(y), i._index.push(g);
  ...
  t.prototype.reshape = function(i, d) {
    ...
    i.forEach(function($) {
      if (!cr($) || !pr($) || $ <= -2 || $ === 0) throw new TypeError("Invalid size, must contain positive integers or -1 (size: " + dr(i) + ")");
    });
    ...
    for (var w = [], A = 0; A < y._ptr.length; A++) for (var F = 0; F < y._ptr[A + 1] - y._ptr[A]; F++) w.push(A);
    ...
    var h = this, C = this._size[0], y = this._size[1], w = ge(i, h, "map"), A = function(b, E, g) {
      return w.fn(b, [E, g], h);
    };
    return v(this, 0, C - 1, 0, y - 1, A, d);
  };
  function v(i, d, h, C, y, w, A) {
    var F = [], b = [], E = [], g = n, B = 0;
    Or(i._datatype) && (g = e.find(n, [i._datatype, i._datatype]) || n, B = e.convert(0, i._datatype));
    for (var _ = function(I, J, G) {
      var V = w(I, J, G);
      g(V, B) || (F.push(V), b.push(J));
    }, x = C; x <= y; x++) {
      E.push(F.length);
      var N = i._ptr[x], S = i._ptr[x + 1];
      if (A) for (var O = N; O < S; O++) {
        var M = i._index[O];
    ...
    return E.push(F.length), new t({ values: F, index: b, ptr: E, size: [h - d + 1, y - C + 1] });
  }
  t.prototype.forEach = function(i, d) {
    if (!this._values) throw new Error("Cannot invoke forEach on a Pattern only matrix");
    for (var h = this, C = this._size[0], y = this._size[1], w = ge(i, h, "forEach"), A = 0; A < y; A++) {
      var F = this._ptr[A], b = this._ptr[A + 1];
      if (d) for (var E = F; E < b; E++) {
        var g = this._index[E];
        w.fn(this._values[E], [g, A], h);
      }
      else {
        for (var B = {}, _ = F; _ < b; _++) {
          var x = this._index[_];
  ...
  function p(i, d, h, C, y) {
    var w = C[0], A = C[1], F = [], b, E;
    for (b = 0; b < w; b++) for (F[b] = [], E = 0; E < A; E++) F[b][E] = 0;
    for (E = 0; E < A; E++) for (var g = h[E], B = h[E + 1], _ = g; _ < B; _++) b = d[_], F[b][E] = i ? y ? ur(i[_]) : i[_] : 1;
    return F;
  }
...
`, w = 0; w < h; w++) for (var A = this._ptr[w], F = this._ptr[w + 1], b = A; b < F; b++) {
      var E = this._index[b];
      y += `
    ...
    if (i) {
      if (Fr(i) && (i = i.toNumber()), !cr(i) || !pr(i)) throw new TypeError("The parameter k must be an integer number");
    } else i = 0;
    var d = i > 0 ? i : 0, h = i < 0 ? -i : 0, C = this._size[0], y = this._size[1], w = Math.min(C - h, y - d), A = [], F = [], b = [];
    b[0] = 0;
    for (var E = d; E < y && A.length < w; E++) for (var g = this._ptr[E], B = this._ptr[E + 1], _ = g; _ < B; _++) {
      var x = this._index[_];
      if (x === E - d + h) {
        A.push(this._values[_]), F[A.length - 1] = x - h;
        break;
      }
    }
    return b.push(A.length), new t({ values: A, index: F, ptr: b, size: [w, 1] });
    ...
    if (i = i.map(function($) {
      if (Fr($) && ($ = $.toNumber()), !cr($) || !pr($) || $ < 1) throw new Error("Size values must be positive integers");
      return $;
    }), h) {
      if (Fr(h) && (h = h.toNumber()), !cr(h) || !pr(h)) throw new TypeError("The parameter k must be an integer number");
    } else h = 0;
    var w = n, A = 0;
    Or(y) && (w = e.find(n, [y, y]) || n, A = e.convert(0, y));
    var F = h > 0 ? h : 0, b = h < 0 ? -h : 0, E = i[0], g = i[1], B = Math.min(E - b, g - F), _;
    if (mr(d)) {
    ...
    for (var N = [], S = [], O = [], M = 0; M < g; M++) {
      ...
      if (R >= 0 && R < B) {
        var T = _(R);
        w(T, A) || (S.push(R + b), N.push(T));
      }
    }
    return O.push(N.length), new t({ values: N, index: S, ptr: O, size: [E, g] });
  }, t.prototype.swapRows = function(i, d) {
    if (!cr(i) || !pr(i) || !cr(d) || !pr(d)) throw new Error("Row index must be positive integers");
    if (this._size.length !== 2) throw new Error("Only two dimensional matrix is supported");
    ...
    for (var w = C[i], A = C[i + 1], F = w; F < A; F++) y(h[F], d[F]);
  }, t._swapRows = function(i, d, h, C, y, w) {
    for (var A = 0; A < h; A++) {
      var F = w[A], b = w[A + 1], E = c(i, F, b, y), g = c(d, F, b, y);
...
}, { isClass: true }), qa = "number", Ra = ["typed"];
function Ua(r) {
...
var La = Z(qa, Ra, (r) => {
...
}), Va = "bignumber", Wa = ["typed", "BigNumber"], Za = Z(Va, Wa, (r) => {
...
}), Ja = "complex", Qa = ["typed", "Complex"], Xa = Z(Ja, Qa, (r) => {
...
}), Ga = "fraction", Ya = ["typed", "Fraction"], Ka = Z(Ga, Ya, (r) => {
...
}), Ct = "matrix", Ha = ["typed", "Matrix", "DenseMatrix", "SparseMatrix"], ka = Z(Ct, Ha, (r) => {
...
}), wt = "matrixFromColumns", ja = ["typed", "matrix", "flatten", "size"], ri = Z(wt, ja, (r) => {
...
}), bt = "unaryMinus", ei = ["typed"], ti = Z(bt, ei, (r) => {
  var { typed: e } = r;
  return e(bt, { number: Nn, "Complex | BigNumber | Fraction": (n) => n.neg(), bigint: (n) => -n, Unit: e.referToSelf((n) => (u) => {
    var t = u.clone();
    return t.value = e.find(n, t.valueType())(u.value), t;
  }), "Array | Matrix": e.referToSelf((n) => (u) => Mr(u, n, true)) });
}), _t = "abs", ni = ["typed"], ui = Z(_t, ni, (r) => {
  var { typed: e } = r;
  return e(_t, { number: Bn, "Complex | BigNumber | Fraction | Unit": (n) => n.abs(), bigint: (n) => n < 0n ? -n : n, "Array | Matrix": e.referToSelf((n) => (u) => Mr(u, n, true)) });
}), Bt = "addScalar", ai = ["typed"], ii = Z(Bt, ai, (r) => {
  var { typed: e } = r;
  return e(Bt, { "number, number": xn, "Complex, Complex": function(u, t) {
    return u.add(t);
...
}), xt = "subtractScalar", oi = ["typed"], si = Z(xt, oi, (r) => {
  var { typed: e } = r;
  return e(xt, { "number, number": Sn, "Complex, Complex": function(u, t) {
    return u.sub(t);
  }, "BigNumber, BigNumber": function(u, t) {
    return u.minus(t);
  }, "bigint, bigint": function(u, t) {
...
}), fi = "matAlgo11xS0s", li = ["typed", "equalScalar"], ci = Z(fi, li, (r) => {
  var { typed: e, equalScalar: n } = r;
  return function(t, a, s, D) {
    ...
    return A[p] = w.length, t.createSparseMatrix({ values: y, index: w, ptr: A, size: [v, p], datatype: i });
  };
}), vi = "matAlgo12xSfs", Di = ["typed", "DenseMatrix"], Hr = Z(vi, Di, (r) => {
  ...
  return function(t, a, s, D) {
    ...
    for (var h = [], C = [], y = [], w = 0; w < p; w++) {
      for (var A = w + 1, F = o[w], b = o[w + 1], E = F; E < b; E++) {
        var g = c[E];
        C[g] = f[E], y[g] = A;
      }
      for (var B = 0; B < v; B++) w === 0 && (h[B] = []), y[B] === A ? h[B][w] = D ? d(a, C[B]) : d(C[B], a) : h[B][w] = D ? d(a, 0) : d(0, a);
    }
    return new n({ data: h, size: [v, p], datatype: i });
  };
}), pi = "matAlgo14xDs", di = ["typed"], On = Z(pi, di, (r) => {
  var { typed: e } = r;
  return function(t, a, s, D) {
...
}), hi = "matAlgo03xDSf", mi = ["typed"], kr = Z(hi, mi, (r) => {
  var { typed: e } = r;
  return function(u, t, a, s) {
    ...
    for (var F = [], b = [], E = 0; E < d; E++) {
      for (var g = E + 1, B = m[E], _ = m[E + 1], x = B; x < _; x++) {
        var N = l[x];
        F[N] = s ? y(o[x], D[N][E]) : y(D[N][E], o[x]), b[N] = g;
      }
      for (var S = 0; S < i; S++) b[S] === g ? w[S][E] = F[S] : w[S][E] = s ? y(C, D[S][E]) : y(D[S][E], C);
    }
    return u.createDenseMatrix({ data: w, size: [i, d], datatype: c === u._datatype && p === t._datatype ? h : void 0 });
  };
}), gi = "matAlgo05xSfSf", yi = ["typed", "equalScalar"], Fi = Z(gi, yi, (r) => {
  var { typed: e, equalScalar: n } = r;
  return function(t, a, s) {
    ...
    var h = o[0], C = o[1], y, w = n, A = 0, F = s;
    typeof l == "string" && l === d && l !== "mixed" && (y = l, w = e.find(n, [y, y]), A = e.convert(0, y), F = e.find(s, [y, y]));
...
var bi = "matrixAlgorithmSuite", _i = ["typed", "matrix"], Qr = Z(bi, _i, (r) => {
  var { typed: e, matrix: n } = r, u = Ci({ typed: e }), t = On({ typed: e });
  return function(s) {
    var D = s.elop, f = s.SD || s.DS, c;
    D ? (c = { "DenseMatrix, DenseMatrix": (v, p) => u(...Ar(v, p), D), "Array, Array": (v, p) => u(...Ar(n(v), n(p)), D).valueOf(), "Array, DenseMatrix": (v, p) => u(...Ar(n(v), p), D), "DenseMatrix, Array": (v, p) => u(...Ar(v, n(p)), D) }, s.SS && (c["SparseMatrix, SparseMatrix"] = (v, p) => s.SS(...Ar(v, p), D, false)), s.DS && (c["DenseMatrix, SparseMatrix"] = (v, p) => s.DS(...Ar(v, p), D, false), c["Array, SparseMatrix"] = (v, p) => s.DS(...Ar(n(v), p), D, false)), f && (c["SparseMatrix, DenseMatrix"] = (v, p) => f(...Ar(p, v), D, true), c["SparseMatrix, Array"] = (v, p) => f(...Ar(n(p), v), D, true))) : (c = { "DenseMatrix, DenseMatrix": e.referToSelf((v) => (p, i) => u(...Ar(p, i), v)), "Array, Array": e.referToSelf((v) => (p, i) => u(...Ar(n(p), n(i)), v).valueOf()), "Array, DenseMatrix": e.referToSelf((v) => (p, i) => u(...Ar(n(p), i), v)), "DenseMatrix, Array": e.referToSelf((v) => (p, i) => u(...Ar(p, n(i)), v)) }, s.SS && (c["SparseMatrix, SparseMatrix"] = e.referToSelf((v) => (p, i) => s.SS(...Ar(p, i), v, false))), s.DS && (c["DenseMatrix, SparseMatrix"] = e.referToSelf((v) => (p, i) => s.DS(...Ar(p, i), v, false)), c["Array, SparseMatrix"] = e.referToSelf((v) => (p, i) => s.DS(...Ar(n(p), i), v, false))), f && (c["SparseMatrix, DenseMatrix"] = e.referToSelf((v) => (p, i) => f(...Ar(i, p), v, true)), c["SparseMatrix, Array"] = e.referToSelf((v) => (p, i) => f(...Ar(n(i), p), v, true))));
    ...
    return D ? (s.Ss && (c["SparseMatrix," + o] = (v, p) => s.Ss(v, p, D, false)), m && (c[o + ", SparseMatrix"] = (v, p) => m(p, v, D, true))) : (s.Ss && (c["SparseMatrix," + o] = e.referToSelf((v) => (p, i) => s.Ss(p, i, v, false))), m && (c[o + ", SparseMatrix"] = e.referToSelf((v) => (p, i) => m(i, p, v, true)))), D && D.signatures && Tu(c, D.signatures), c;
  };
}), Bi = "matAlgo01xDSid", xi = ["typed"], $n = Z(Bi, xi, (r) => {
  var { typed: e } = r;
  return function(u, t, a, s) {
    var D = u._data, f = u._size, c = u._datatype || u.getDataType(), o = t._values, l = t._index, m = t._ptr, v = t._size, p = t._datatype || t._data === void 0 ? t._datatype : t.getDataType();
    if (f.length !== v.length) throw new ar(f.length, v.length);
    if (f[0] !== v[0] || f[1] !== v[1]) throw new RangeError("Dimension mismatch. Matrix A (" + f + ") must match Matrix B (" + v + ")");
    if (!o) throw new Error("Cannot perform operation on Dense Matrix and Pattern Sparse Matrix");
    var i = f[0], d = f[1], h = typeof c == "string" && c !== "mixed" && c === p ? c : void 0, C = h ? e.find(a, [h, h]) : a, y, w, A = [];
    for (y = 0; y < i; y++) A[y] = [];
    var F = [], b = [];
    for (w = 0; w < d; w++) {
      for (var E = w + 1, g = m[w], B = m[w + 1], _ = g; _ < B; _++) y = l[_], F[y] = s ? C(o[_], D[y][w]) : C(D[y][w], o[_]), b[y] = E;
      for (y = 0; y < i; y++) b[y] === E ? A[y][w] = F[y] : A[y][w] = D[y][w];
    }
    return u.createDenseMatrix({ data: A, size: [i, d], datatype: c === u._datatype && p === t._datatype ? h : void 0 });
  };
...
}), Ti = "matAlgo10xSids", zi = ["typed", "DenseMatrix"], In = Z(Ti, zi, (r) => {
  var { typed: e, DenseMatrix: n } = r;
  return function(t, a, s, D) {
    var f = t._values, c = t._index, o = t._ptr, l = t._size, m = t._datatype;
    if (!f) throw new Error("Cannot perform operation on Pattern Sparse Matrix and Scalar value");
    ...
    for (var h = [], C = [], y = [], w = 0; w < p; w++) {
      ...
      for (var B = 0; B < v; B++) w === 0 && (h[B] = []), y[B] === A ? h[B][w] = D ? d(a, C[B]) : d(C[B], a) : h[B][w] = a;
    }
    return new n({ data: h, size: [v, p], datatype: i });
  };
}), Oi = "multiplyScalar", $i = ["typed"], Ii = Z(Oi, $i, (r) => {
  var { typed: e } = r;
  return e("multiplyScalar", { "number, number": Mn, "Complex, Complex": function(u, t) {
    return u.mul(t);
  }, "BigNumber, BigNumber": function(u, t) {
    return u.times(t);
  }, "bigint, bigint": function(u, t) {
...
}), St = "multiply", qi = ["typed", "matrix", "addScalar", "multiplyScalar", "equalScalar", "dot"], Ri = Z(St, qi, (r) => {
  var { typed: e, matrix: n, addScalar: u, multiplyScalar: t, equalScalar: a, dot: s } = r, D = ci({ typed: e, equalScalar: a }), f = On({ typed: e });
  function c(A, F) {
    switch (A.length) {
      case 1:
        switch (F.length) {
  ...
  function m(A, F) {
    var b = A._data, E = A._size, g = A._datatype || A.getDataType(), B = F._data, _ = F._size, x = F._datatype || F.getDataType(), N = E[0], S = _[1], O, M = u, R = t;
    g && x && g === x && typeof g == "string" && g !== "mixed" && (O = g, M = e.find(u, [O, O]), R = e.find(t, [O, O]));
    for (var T = [], $ = 0; $ < S; $++) {
      for (var Q = R(b[0], B[0][$]), Y = 1; Y < N; Y++) Q = M(Q, R(b[Y], B[Y][$]));
      T[$] = Q;
    }
    return A.createDenseMatrix({ data: T, size: [S], datatype: g === A._datatype && x === F._datatype ? O : void 0 });
  }
  ...
  function i(A, F) {
    var b = A._data, E = A._size, g = A._datatype || A.getDataType(), B = F._data, _ = F._datatype || F.getDataType(), x = E[0], N = E[1], S, O = u, M = t;
    g && _ && g === _ && typeof g == "string" && g !== "mixed" && (S = g, O = e.find(u, [S, S]), M = e.find(t, [S, S]));
    for (var R = [], T = 0; T < x; T++) {
      for (var $ = b[T], Q = M($[0], B[0]), Y = 1; Y < N; Y++) Q = O(Q, M($[Y], B[Y]));
      R[T] = Q;
    }
    return A.createDenseMatrix({ data: R, size: [x], datatype: g === A._datatype && _ === F._datatype ? S : void 0 });
  }
  function d(A, F) {
    var b = A._data, E = A._size, g = A._datatype || A.getDataType(), B = F._data, _ = F._size, x = F._datatype || F.getDataType(), N = E[0], S = E[1], O = _[1], M, R = u, T = t;
    ...
    return A.createDenseMatrix({ data: $, size: [N, O], datatype: g === A._datatype && x === F._datatype ? M : void 0 });
  }
  function h(A, F) {
    var b = A._data, E = A._size, g = A._datatype || A.getDataType(), B = F._values, _ = F._index, x = F._ptr, N = F._size, S = F._datatype || F._data === void 0 ? F._datatype : F.getDataType();
    ...
    for (var z = [], I = [], J = [], G = F.createSparseMatrix({ values: z, index: I, ptr: J, size: [O, M], datatype: g === A._datatype && S === F._datatype ? R : void 0 }), V = 0; V < M; V++) {
      J[V] = I.length;
      var q = x[V], W = x[V + 1];
  ...
  function C(A, F) {
    var b = A._values, E = A._index, g = A._ptr, B = A._datatype || A._data === void 0 ? A._datatype : A.getDataType();
    if (!b) throw new Error("Cannot multiply Pattern only Matrix times Dense Matrix");
    var _ = F._data, x = F._datatype || F.getDataType(), N = A._size[0], S = F._size[0], O = [], M = [], R = [], T, $ = u, Q = t, Y = a, z = 0;
    ...
    return R[1] = M.length, A.createSparseMatrix({ values: O, index: M, ptr: R, size: [N, 1], datatype: B === A._datatype && x === F._datatype ? T : void 0 });
  }
  function y(A, F) {
    var b = A._values, E = A._index, g = A._ptr, B = A._datatype || A._data === void 0 ? A._datatype : A.getDataType();
    if (!b) throw new Error("Cannot multiply Pattern only Matrix times Dense Matrix");
    var _ = F._data, x = F._datatype || F.getDataType(), N = A._size[0], S = F._size[0], O = F._size[1], M, R = u, T = t, $ = a, Q = 0;
    B && x && B === x && typeof B == "string" && B !== "mixed" && (M = B, R = e.find(u, [M, M]), T = e.find(t, [M, M]), $ = e.find(a, [M, M]), Q = e.convert(0, M));
    for (var Y = [], z = [], I = [], J = A.createSparseMatrix({ values: Y, index: z, ptr: I, size: [N, O], datatype: B === A._datatype && x === F._datatype ? M : void 0 }), G = [], V = [], q = 0; q < O; q++) {
      I[q] = z.length;
  ...
  function w(A, F) {
    var b = A._values, E = A._index, g = A._ptr, B = A._datatype || A._data === void 0 ? A._datatype : A.getDataType(), _ = F._values, x = F._index, N = F._ptr, S = F._datatype || F._data === void 0 ? F._datatype : F.getDataType(), O = A._size[0], M = F._size[1], R = b && _, T, $ = u, Q = t;
    B && S && B === S && typeof B == "string" && B !== "mixed" && (T = B, $ = e.find(u, [T, T]), Q = e.find(t, [T, T]));
    for (var Y = R ? [] : void 0, z = [], I = [], J = A.createSparseMatrix({ values: Y, index: z, ptr: I, size: [O, M], datatype: B === A._datatype && S === F._datatype ? T : void 0 }), G = R ? [] : void 0, V = [], q, W, P, U, K, L, j, er, tr = 0; tr < M; tr++) {
      I[tr] = z.length;
      var nr = tr + 1;
  ...
  return e(St, t, { "Array, Array": e.referTo("Matrix, Matrix", (A) => (F, b) => {
    c(sr(F), sr(b));
    var E = A(n(F), n(b));
    return fr(E) ? E.valueOf() : E;
  }), "Matrix, Matrix": function(F, b) {
    var E = F.size(), g = b.size();
    return c(E, g), E.length === 1 ? g.length === 1 ? o(F, b, E[0]) : l(F, b) : g.length === 1 ? v(F, b) : p(F, b);
  }, "Matrix, Array": e.referTo("Matrix,Matrix", (A) => (F, b) => A(F, n(b))), "Array, Matrix": e.referToSelf((A) => (F, b) => A(n(F, b.storage()), b)), "SparseMatrix, any": function(F, b) {
    return D(F, b, t, false);
  }, "DenseMatrix, any": function(F, b) {
    return f(F, b, t, false);
  }, "any, SparseMatrix": function(F, b) {
    return D(b, F, t, true);
  }, "any, DenseMatrix": function(F, b) {
    return f(b, F, t, true);
  }, "Array, any": function(F, b) {
    return f(n(F), b, t, false).valueOf();
  }, "any, Array": function(F, b) {
    return f(n(b), F, t, true).valueOf();
  }, "any, any": t, "any, any, ...any": e.referToSelf((A) => (F, b, E) => {
    for (var g = A(F, b), B = 0; B < E.length; B++) g = A(g, E[B]);
    return g;
  }) });
}), Mt = "sign", Ui = ["typed", "BigNumber", "Fraction", "complex"], Pi = Z(Mt, Ui, (r) => {
  var { typed: e, BigNumber: n, complex: u, Fraction: t } = r;
  return e(Mt, { number: Ve, Complex: function(s) {
...
}), Nt = "subtract", Zi = ["typed", "matrix", "equalScalar", "subtractScalar", "unaryMinus", "DenseMatrix", "concat"], Ji = Z(Nt, Zi, (r) => {
  var { typed: e, matrix: n, equalScalar: u, subtractScalar: t, unaryMinus: a, DenseMatrix: s, concat: D } = r, f = $n({ typed: e }), c = kr({ typed: e }), o = Fi({ typed: e, equalScalar: u }), l = In({ typed: e, DenseMatrix: s }), m = Hr({ typed: e, DenseMatrix: s }), v = Qr({ typed: e, matrix: n, concat: D });
  return e(Nt, { "any, any": t }, v({ elop: t, SS: o, DS: f, SD: c, Ss: m, sS: l }));
  ...
  return function(a, s, D) {
    ...
    for (var h = [], C = [], y = new Array(v + 1).fill(0), w = [], A = [], F = [], b = [], E = 0; E < v; E++) {
      var g = E + 1, B = 0;
      u(a, E, F, w, g), u(s, E, b, A, g);
      for (var _ = 0; _ < m; _++) {
        var x = F[_] === g ? w[_] : i, N = b[_] === g ? A[_] : i, S = d(x, N);
...
}), Tt = "conj", Gi = ["typed"], Yi = Z(Tt, Gi, (r) => {
  var { typed: e } = r;
  return e(Tt, { "number | BigNumber | Fraction": (n) => n, Complex: (n) => n.conjugate(), "Array | Matrix": e.referToSelf((n) => (u) => Mr(u, n)) });
}), zt = "im", Ki = ["typed"], Hi = Z(zt, Ki, (r) => {
  var { typed: e } = r;
  return e(zt, { number: () => 0, "BigNumber | Fraction": (n) => n.mul(0), Complex: (n) => n.im, "Array | Matrix": e.referToSelf((n) => (u) => Mr(u, n)) });
}), Ot = "re", ki = ["typed"], ji = Z(Ot, ki, (r) => {
  var { typed: e } = r;
  return e(Ot, { "number | BigNumber | Fraction": (n) => n, Complex: (n) => n.re, "Array | Matrix": e.referToSelf((n) => (u) => Mr(u, n)) });
}), $t = "concat", ro = ["typed", "matrix", "isInteger"], eo = Z($t, ro, (r) => {
  var { typed: e, matrix: n, isInteger: u } = r;
  return e($t, { "...Array | Matrix | number | BigNumber": function(a) {
    var s, D = a.length, f = -1, c, o = false, l = [];
    for (s = 0; s < D; s++) {
      var m = a[s];
      if (fr(m) && (o = true), cr(m) || Fr(m)) {
    ...
    for (var i = l.shift(); l.length; ) i = Cn(i, l.shift(), f);
    return o ? n(i) : i;
  }, "...string": function(a) {
    return a.join("");
  } });
}), It = "column", to = ["typed", "Index", "matrix", "range"], no = Z(It, to, (r) => {
  var { typed: e, Index: n, matrix: u, range: t } = r;
  return e(It, { "Matrix, number": a, "Array, number": function(D, f) {
...
}), qt = "cross", uo = ["typed", "matrix", "subtract", "multiply"], ao = Z(qt, uo, (r) => {
  var { typed: e, matrix: n, subtract: u, multiply: t } = r;
  return e(qt, { "Matrix, Matrix": function(D, f) {
...
}), Rt = "diag", io = ["typed", "matrix", "DenseMatrix", "SparseMatrix"], oo = Z(Rt, io, (r) => {
  var { typed: e, matrix: n, DenseMatrix: u, SparseMatrix: t } = r;
  return e(Rt, { Array: function(c) {
...
}), Ut = "flatten", so = ["typed"], fo = Z(Ut, so, (r) => {
  var { typed: e } = r;
  return e(Ut, { Array: function(u) {
    return Pe(u);
  }, Matrix: function(u) {
    return u.create(Pe(u.valueOf(), true), u.datatype());
  } });
}), Pt = "getMatrixDataType", lo = ["typed"], co = Z(Pt, lo, (r) => {
  var { typed: e } = r;
  return e(Pt, { Array: function(u) {
    return xe(u, $r);
  }, Matrix: function(u) {
    return u.getDataType();
  } });
}), Lt = "identity", vo = ["typed", "config", "matrix", "BigNumber", "DenseMatrix", "SparseMatrix"], Do = Z(Lt, vo, (r) => {
  ...
  function f(c, o, l) {
    var m = Fr(c) || Fr(o) ? t : null;
    if (Fr(c) && (c = c.toNumber()), Fr(o) && (o = o.toNumber()), !pr(c) || c < 1) throw new Error("Parameters in function identity must be positive integers");
...
var Vt = "range", ho = ["typed", "config", "?matrix", "?bignumber", "smaller", "smallerEq", "larger", "largerEq", "add", "isPositive"], mo = Z(Vt, ho, (r) => {
  var { typed: e, config: n, matrix: u, bignumber: t, smaller: a, smallerEq: s, larger: D, largerEq: f, add: c, isPositive: o } = r;
  return e(Vt, { string: m, "string, boolean": m, number: function(d) {
  ...
  function l(i) {
    return n.matrix === "Matrix" ? u ? u(i) : Rn() : i;
  }
  function m(i, d) {
    var h = p(i);
    if (!h) throw new SyntaxError('String "' + i + '" is no valid range');
    return n.number === "BigNumber" ? (t === void 0 && qn(), l(v(t(h.start), t(h.end), t(h.step)))) : l(v(h.start, h.end, h.step, d));
  }
  function v(i, d, h, C) {
    for (var y = [], w = o(h) ? C ? s : a : C ? f : D, A = i; w(A, d); ) y.push(A), A = c(A, h);
    return y;
  }
  function p(i) {
...
}), Wt = "reshape", go = ["typed", "isInteger", "matrix"], yo = Z(Wt, go, (r) => {
  var { typed: e, isInteger: n } = r;
  return e(Wt, { "Matrix, Array": function(t, a) {
...
}), Zt = "size", Fo = ["typed", "config", "?matrix"], Ao = Z(Zt, Fo, (r) => {
  var { typed: e, config: n, matrix: u } = r;
  return e(Zt, { Matrix: function(a) {
    ...
    return n.matrix === "Array" ? [] : u ? u([], "dense", "number") : Rn();
  } });
}), Jt = "transpose", Eo = ["typed", "matrix"], Co = Z(Jt, Eo, (r) => {
  var { typed: e, matrix: n } = r;
  return e(Jt, { Array: (s) => u(n(s)).valueOf(), Matrix: u, any: ur });
  function u(s) {
    var D = s.size(), f;
    switch (D.length) {
      case 1:
  ...
  function a(s, D, f) {
    ...
    for (var w = 0, A = 0; A < D; A++) p.push(w), w += i[A], i[A] = p[A];
    for (p.push(w), y = 0; y < f; y++) for (var F = l[y], b = l[y + 1], E = F; E < b; E++) {
      var g = i[o[E]]++;
      v[g] = y, c && (m[g] = ur(c[E]));
    }
    return s.createSparseMatrix({ values: m, index: v, ptr: p, size: [f, D], datatype: s._datatype });
  }
}), Qt = "ctranspose", wo = ["typed", "transpose", "conj"], bo = Z(Qt, wo, (r) => {
  var { typed: e, transpose: n, conj: u } = r;
  return e(Qt, { any: function(a) {
    return u(n(a));
  } });
}), Xt = "zeros", _o = ["typed", "config", "matrix", "BigNumber"], Bo = Z(Xt, _o, (r) => {
  ...
  var { number: e, bignumber: n, fraction: u } = r, t = { string: true, number: true, BigNumber: true, Fraction: true }, a = { number: (s) => e(s), BigNumber: n ? (s) => n(s) : qn, bigint: (s) => BigInt(s), Fraction: u ? (s) => u(s) : po };
  return function(D) {
...
}), Gt = "divideScalar", No = ["typed", "numeric"], To = Z(Gt, No, (r) => {
  var { typed: e, numeric: n } = r;
  return e(Gt, { "number, number": function(t, a) {
    return t / a;
...
}), Yt = "pow", zo = ["typed", "config", "identity", "multiply", "matrix", "inv", "fraction", "number", "Complex"], Oo = Z(Yt, zo, (r) => {
  var { typed: e, config: n, identity: u, multiply: t, matrix: a, inv: s, number: D, fraction: f, Complex: c } = r;
  return e(Yt, { "number, number": o, "Complex, Complex": function(p, i) {
    return p.pow(i);
  ...
  function o(v, p) {
    ...
    return n.predictable && (v < -1 && p === 1 / 0 || v > -1 && v < 0 && p === -1 / 0) ? NaN : pr(p) || v >= 0 || n.predictable ? Tn(v, p) : v * v < 1 && p === 1 / 0 || v * v > 1 && p === -1 / 0 ? 0 : new c(v, 0).pow(p, 0);
  }
  function l(v, p) {
...
function Un(r) {
  ...
  return function(u, t, a) {
    ...
    if (mr(t)) {
      var A = sr(t);
      if (A.length === 1) {
        if (A[0] !== D) throw new RangeError("Dimension mismatch. Matrix columns must match vector length.");
        for (var F = 0; F < D; F++) c[F] = [t[F]];
        return new e({ data: c, size: [D, 1] });
      }
      if (A.length === 2) {
        if (A[0] !== D || A[1] !== 1) throw new RangeError("Dimension mismatch. Matrix columns must match vector length.");
...
var Kt = "usolve", $o = ["typed", "matrix", "divideScalar", "multiplyScalar", "subtractScalar", "equalScalar", "DenseMatrix"], Io = Z(Kt, $o, (r) => {
  var { typed: e, matrix: n, divideScalar: u, multiplyScalar: t, subtractScalar: a, equalScalar: s, DenseMatrix: D } = r, f = Un({ DenseMatrix: D });
  ...
  function c(l, m) {
    ...
    for (var v = m._data, p = l._size[0], i = l._size[1], d = [], h = l._data, C = i - 1; C >= 0; C--) {
      ...
      if (s(y, 0)) w = 0;
        ...
        w = u(y, A);
        for (var F = C - 1; F >= 0; F--) v[F] = [a(v[F][0] || 0, t(w, h[F][C]))];
      }
      d[C] = [w];
    }
...
}), Ht = "usolveAll", qo = ["typed", "matrix", "divideScalar", "multiplyScalar", "subtractScalar", "equalScalar", "DenseMatrix"], Ro = Z(Ht, qo, (r) => {
  var { typed: e, matrix: n, divideScalar: u, multiplyScalar: t, subtractScalar: a, equalScalar: s, DenseMatrix: D } = r, f = Un({ DenseMatrix: D });
  return e(Ht, { "SparseMatrix, Array | Matrix": function(m, v) {
    return o(m, v);
  }, "DenseMatrix, Array | Matrix": function(m, v) {
    return c(m, v);
  }, "Array, Array | Matrix": function(m, v) {
    ...
    for (var v = [f(l, m, true)._data.map((E) => E[0])], p = l._data, i = l._size[0], d = l._size[1], h = d - 1; h >= 0; h--) for (var C = v.length, y = 0; y < C; y++) {
      ...
      if (s(p[h][h], 0)) if (s(w[h], 0)) {
        if (y === 0) {
          var F = [...w];
          F[h] = 1;
          for (var b = h - 1; b >= 0; b--) F[b] = a(F[b], p[b][h]);
          v.push(F);
        }
      } else {
        if (y === 0) return [];
        ...
        w[h] = u(w[h], p[h][h]);
        for (var A = h - 1; A >= 0; A--) w[A] = a(w[A], t(w[h], p[A][h]));
      }
    }
    return v.map((E) => new D({ data: E.map((g) => [g]), size: [i, 1] }));
  }
  function o(l, m) {
    for (var v = [f(l, m, true)._data.map((Y) => Y[0])], p = l._size[0], i = l._size[1], d = l._values, h = l._index, C = l._ptr, y = i - 1; y >= 0; y--) for (var w = v.length, A = 0; A < w; A++) {
      for (var F = v[A], b = [], E = [], g = C[y], B = C[y + 1], _ = 0, x = B - 1; x >= g; x--) {
        var N = h[x];
...
}), Fe = "equal", Uo = ["typed", "matrix", "equalScalar", "DenseMatrix", "concat", "SparseMatrix"], Po = Z(Fe, Uo, (r) => {
  var { typed: e, matrix: n, equalScalar: u, DenseMatrix: t, concat: a, SparseMatrix: s } = r, D = kr({ typed: e }), f = ie({ typed: e, SparseMatrix: s }), c = Hr({ typed: e, DenseMatrix: t }), o = Qr({ typed: e, matrix: n, concat: a });
  return e(Fe, Lo({ typed: e, equalScalar: u }), o({ elop: u, SS: f, DS: D, Ss: c }));
}), Lo = Z(Fe, ["typed", "equalScalar"], (r) => {
  var { typed: e, equalScalar: n } = r;
  return e(Fe, { "any, any": function(t, a) {
    return t === null ? a === null : a === null ? t === null : t === void 0 ? a === void 0 : a === void 0 ? t === void 0 : n(t, a);
  } });
}), Ae = "smaller", Vo = ["typed", "config", "bignumber", "matrix", "DenseMatrix", "concat", "SparseMatrix"], Wo = Z(Ae, Vo, (r) => {
  var { typed: e, config: n, bignumber: u, matrix: t, DenseMatrix: a, concat: s, SparseMatrix: D } = r, f = kr({ typed: e }), c = ie({ typed: e, SparseMatrix: D }), o = Hr({ typed: e, DenseMatrix: a }), l = Qr({ typed: e, matrix: t, concat: s }), m = ae({ typed: e });
  function v(p, i) {
    return p.lt(i) && !Kr(p, i, n.relTol, n.absTol);
  }
  return e(Ae, Zo({ typed: e, config: n }), { "boolean, boolean": (p, i) => p < i, "BigNumber, BigNumber": v, "bigint, bigint": (p, i) => p < i, "Fraction, Fraction": (p, i) => p.compare(i) === -1, "Fraction, BigNumber": function(i, d) {
    return v(u(i), d);
...
}), Zo = Z(Ae, ["typed", "config"], (r) => {
  var { typed: e, config: n } = r;
  return e(Ae, { "number, number": function(t, a) {
    return t < a && !Rr(t, a, n.relTol, n.absTol);
  } });
}), Ee = "smallerEq", Jo = ["typed", "config", "matrix", "DenseMatrix", "concat", "SparseMatrix"], Qo = Z(Ee, Jo, (r) => {
  var { typed: e, config: n, matrix: u, DenseMatrix: t, concat: a, SparseMatrix: s } = r, D = kr({ typed: e }), f = ie({ typed: e, SparseMatrix: s }), c = Hr({ typed: e, DenseMatrix: t }), o = Qr({ typed: e, matrix: u, concat: a }), l = ae({ typed: e });
  ...
  function u(a) {
    ...
    for (var s = 0, D = arguments.length; s < D; s++) {
      ...
      if (vn(f)) this._dimensions.push(f), this._isScalar = false;
      else if (c || o) {
        var v = void 0;
        n(f) === "boolean" ? (c && (v = t(kt(f).valueOf())), o && (v = t(kt(f._data).valueOf())), m = f.valueOf().length) : v = t(f.valueOf()), this._dimensions.push(v);
        var p = v.size();
...
var is = "atan", os = ["typed"], ss = Z(is, os, (r) => {
...
}), jt = "cos", fs = ["typed"], ls = Z(jt, fs, (r) => {
  var { typed: e } = r, n = Pn({ typed: e });
  return e(jt, { number: Math.cos, "Complex | BigNumber": (u) => u.cos() }, n);
}), rn = "sin", cs = ["typed"], vs = Z(rn, cs, (r) => {
  var { typed: e } = r, n = Pn({ typed: e });
  return e(rn, { number: Math.sin, "Complex | BigNumber": (u) => u.sin() }, n);
}), en = "add", Ds = ["typed", "matrix", "addScalar", "equalScalar", "DenseMatrix", "SparseMatrix", "concat"], ps = Z(en, Ds, (r) => {
  var { typed: e, matrix: n, addScalar: u, equalScalar: t, DenseMatrix: a, SparseMatrix: s, concat: D } = r, f = $n({ typed: e }), c = Ni({ typed: e, equalScalar: t }), o = In({ typed: e, DenseMatrix: a }), l = Qr({ typed: e, matrix: n, concat: D });
  return e(en, { "any, any": u, "any, any, ...any": e.referToSelf((m) => (v, p, i) => {
    for (var d = m(v, p), h = 0; h < i.length; h++) d = m(d, i[h]);
    return d;
  }) }, l({ elop: u, DS: f, SS: c, Ss: o }));
}), tn = "norm", ds = ["typed", "abs", "add", "pow", "conj", "sqrt", "multiply", "equalScalar", "larger", "smaller", "matrix", "ctranspose", "eigs"], hs = Z(tn, ds, (r) => {
  var { typed: e, abs: n, add: u, pow: t, conj: a, sqrt: s, multiply: D, equalScalar: f, larger: c, smaller: o, matrix: l, ctranspose: m, eigs: v } = r;
  return e(tn, { number: Math.abs, Complex: function(E) {
    return E.abs();
  ...
  function F(b, E) {
    ...
    if (g.length === 2) {
      if (g[0] && g[1]) return A(b, E);
      throw new RangeError("Invalid matrix dimensions");
    }
  }
}), nn = "dot", ms = ["typed", "addScalar", "multiplyScalar", "conj", "size"], gs = Z(nn, ms, (r) => {
  var { typed: e, addScalar: n, multiplyScalar: u, conj: t, size: a } = r;
  return e(nn, { "Array | DenseMatrix, Array | DenseMatrix": D, "SparseMatrix, SparseMatrix": f });
  function s(o, l) {
    var m = c(o), v = c(l), p, i;
    if (m.length === 1) p = m[0];
  ...
  function D(o, l) {
    ...
    if (p && d && p === d && typeof p == "string" && p !== "mixed") {
      var A = p;
      y = e.find(n, [A, A]), w = e.find(u, [A, A]);
    }
    if (!h && !C) {
      for (var F = w(t(v[0]), i[0]), b = 1; b < m; b++) F = y(F, w(t(v[b]), i[b]));
      return F;
    }
    if (!h && C) {
...
}), un = "qr", ys = ["typed", "matrix", "zeros", "identity", "isZero", "equal", "sign", "sqrt", "conj", "unaryMinus", "addScalar", "divideScalar", "multiplyScalar", "subtractScalar", "complex"], Fs = Z(un, ys, (r) => {
  ...
  return be(e(un, { DenseMatrix: function(w) {
    return h(w);
  ...
  function d(y) {
    var w = y._size[0], A = y._size[1], F = t([w], "dense"), b = F._data, E = y.clone(), g = E._data, B, _, x, N = u([w], "");
...
R: ` + this.R.toString();
  ...
  function h(y) {
    var w = d(y), A = w.R._data;
    if (y._data.length > 0) for (var F = A[0][0].type === "Complex" ? i(0) : 0, b = 0; b < A.length; ++b) for (var E = 0; E < b && E < (A[0] || []).length; ++E) A[b][E] = F;
    return w;
  }
  function C(y) {
    throw new Error("qr not implemented for sparse matrices yet");
  }
}), an = "det", As = ["typed", "matrix", "subtractScalar", "multiply", "divideScalar", "isZero", "unaryMinus"], Es = Z(an, As, (r) => {
  var { typed: e, matrix: n, subtractScalar: u, multiply: t, divideScalar: a, isZero: s, unaryMinus: D } = r;
  return e(an, { any: function(o) {
    return ur(o);
  ...
  function f(c, o, l) {
    ...
    for (var m = false, v = new Array(o).fill(0).map((b, E) => E), p = 0; p < o; p++) {
      ...
      for (var h = c[i][p], C = p === 0 ? 1 : c[v[p - 1]][p - 1], y = p + 1; y < o; y++) for (var w = v[y], A = p + 1; A < o; A++) c[w][A] = a(u(t(c[w][A], h), t(c[w][p], c[i][A])), C);
    }
    var F = c[v[o - 1]][o - 1];
    return m ? D(F) : F;
  }
}), on = "inv", Cs = ["typed", "matrix", "divideScalar", "addScalar", "multiply", "unaryMinus", "det", "identity", "abs"], ws = Z(on, Cs, (r) => {
  var { typed: e, matrix: n, divideScalar: u, addScalar: t, multiply: a, unaryMinus: s, det: D, identity: f, abs: c } = r;
  return e(on, { "Array | Matrix": function(m) {
  ...
  function o(l, m, v) {
    ...
    if (m === 1) {
      ...
      for (var A = f(m).valueOf(), F = 0; F < v; F++) {
        var b = c(w[F][F]), E = F;
        for (p = F + 1; p < m; ) c(w[p][F]) > b && (b = c(w[p][F]), E = p), p++;
        if (b === 0) throw Error("Cannot calculate inverse, determinant is zero");
        p = E, p !== F && (C = w[F], w[F] = w[p], w[p] = C, C = A[F], A[F] = A[p], A[p] = C);
        var g = w[F], B = A[F];
        for (p = 0; p < m; p++) {
          var _ = w[p], x = A[p];
          if (p !== F) {
            if (_[F] !== 0) {
              for (d = u(s(_[F]), g[F]), i = F; i < v; i++) _[i] = t(_[i], a(d, g[i]));
              for (i = 0; i < v; i++) x[i] = t(x[i], a(d, B[i]));
            }
          } else {
            for (d = g[F], i = F; i < v; i++) _[i] = u(_[i], d);
...
function bs(r) {
  var { addScalar: e, subtract: n, flatten: u, multiply: t, multiplyScalar: a, divideScalar: s, sqrt: D, abs: f, bignumber: c, diag: o, size: l, reshape: m, inv: v, qr: p, usolve: i, usolveAll: d, equal: h, complex: C, larger: y, smaller: w, matrixFromColumns: A, dot: F } = r;
  function b(z, I, J, G) {
  ...
  function E(z, I, J, G, V) {
    ...
    for (var tr = false; !tr; ) {
      ...
      for (var nr = 0; nr < I; nr++) {
        ...
        if (!h(ir, 0) && !h(or, 0)) {
          for (var lr = K, Dr = ir, xr = s(or, L), Sr = a(or, L); w(Dr, xr); ) Dr = a(Dr, j), lr = a(lr, L);
          for (; y(Dr, Sr); ) Dr = s(Dr, j), lr = s(lr, L);
          var Cr = w(s(e(Dr, or), lr), a(e(ir, or), 0.95));
          if (Cr) {
            tr = false;
            for (var Wr = s(1, lr), Nr = 0; Nr < I; Nr++) nr !== Nr && (z[nr][Nr] = a(z[nr][Nr], Wr), z[Nr][nr] = a(z[Nr][nr], lr));
            V && (er[nr] = a(er[nr], Wr));
          }
        }
      }
  ...
  function g(z, I, J, G, V, q) {
    ...
    for (var K = 0; K < I - 2; K++) {
      ...
      if (!w(f(j), J)) {
        ...
        for (var lr = K + 2; lr < I; lr++) {
          var Dr = s(z[lr][K], j);
          if (Dr !== 0) {
            for (var xr = 0; xr < I; xr++) z[lr][xr] = n(z[lr][xr], a(Dr, z[K + 1][xr]));
            for (var Sr = 0; Sr < I; Sr++) z[Sr][K + 1] = e(z[Sr][K + 1], a(Dr, z[Sr][lr]));
            if (V) for (var Cr = 0; Cr < I; Cr++) q[lr][Cr] = n(q[lr][Cr], a(Dr, q[K + 1][Cr]));
          }
        }
      }
    }
  ...
  function B(z, I, J, G, V) {
    ...
    if (K.sort((le, Ir) => +n(f(le), f(Ir))), nr > 100) {
  ...
  function _(z, I, J, G, V, q, W) {
    ...
    for (var gr = [], lr = tr.length, Dr = Array(I).fill(j), xr = o(Array(I).fill(er)), Sr = function() {
      var Nr = tr[Cr], le = n(U, t(Nr, xr)), Ir = d(le, Dr);
      for (Ir.shift(); Ir.length < nr[Cr]; ) {
        var ot = R(le, I, Ir, q, W);
        if (ot === null) break;
        Ir.push(ot);
      }
      var Yn = t(v(G), J);
      Ir = Ir.map((Oe) => t(Yn, Oe)), gr.push(...Ir.map((Oe) => ({ value: Nr, vector: u(Oe) })));
    }, Cr = 0; Cr < lr; Cr++) Sr();
    return gr;
  }
  function x(z, I, J, G) {
  ...
  function $(z, I) {
    var J = l(z);
    for (var G of I) G = m(G, J), z = n(z, t(s(F(G, z), F(G, G)), G));
    return z;
  }
  function Q(z) {
    return f(D(F(z, z)));
...
function _s(r) {
  ...
  function p(g, B, _) {
    ...
    for (var R = F(g); Math.abs(R[1]) >= Math.abs(N); ) {
      var T = R[0][0], $ = R[0][1];
      S = d(g[T][T], g[$][$], g[T][$]), g = A(g, S, T, $), _ && (O = C(O, S, T, $)), R = F(g);
    }
...
var Bs = "eigs", xs = ["config", "typed", "matrix", "addScalar", "equal", "subtract", "abs", "atan", "cos", "sin", "multiplyScalar", "divideScalar", "inv", "bignumber", "multiply", "add", "larger", "column", "flatten", "number", "complex", "sqrt", "diag", "size", "reshape", "qr", "usolve", "usolveAll", "im", "re", "smaller", "matrixFromColumns", "dot"], Ss = Z(Bs, xs, (r) => {
  var { config: e, typed: n, matrix: u, addScalar: t, subtract: a, equal: s, abs: D, atan: f, cos: c, sin: o, multiplyScalar: l, divideScalar: m, inv: v, bignumber: p, multiply: i, add: d, larger: h, column: C, flatten: y, number: w, complex: A, sqrt: F, diag: b, size: E, reshape: g, qr: B, usolve: _, usolveAll: x, im: N, re: S, smaller: O, matrixFromColumns: M, dot: R } = r, T = _s({ config: e, addScalar: t, subtract: a, abs: D, atan: f, cos: c, sin: o, multiplyScalar: l, inv: v, bignumber: p, multiply: i, add: d }), $ = bs({ addScalar: t, subtract: a, multiply: i, multiplyScalar: l, flatten: y, divideScalar: m, sqrt: F, abs: D, bignumber: p, diag: b, size: E, reshape: g, qr: B, inv: v, usolve: _, usolveAll: x, equal: s, complex: A, larger: h, smaller: O, matrixFromColumns: M, dot: R });
  ...
  function G(V, q, W) {
    ...
    for (var U = false, K = false, L = false, j = 0; j < W; j++) for (var er = 0; er < W; er++) {
      var tr = q[j][er];
      if (cr(tr) || Ze(tr)) U = true;
      else if (Fr(tr)) K = true;
    ...
    if (K && L && console.warn("Complex BigNumbers not supported, this operation will lose precission."), L) {
      for (var nr = 0; nr < W; nr++) for (var ir = 0; ir < W; ir++) q[nr][ir] = A(q[nr][ir]);
      return "Complex";
    }
    if (K) {
    ...
    if (U) {
      for (var lr = 0; lr < W; lr++) for (var Dr = 0; Dr < W; Dr++) q[lr][Dr] = w(q[lr][Dr]);
      return "number";
    } else throw TypeError("Matrix contains unsupported types only.");
  }
}), oe = Yu({ config: br }), Me = ku({}), He = aa({}), ke = sa({}), Br = Ca({ Matrix: ke }), k = Ju({ BigNumber: oe, Complex: Me, DenseMatrix: Br, Fraction: He }), je = ui({ typed: k }), jr = ii({ typed: k }), Ms = ss({ typed: k }), rt = Xa({ Complex: Me, typed: k }), Ne = Yi({ typed: k }), Ns = ls({ typed: k }), Ur = za({ config: br, typed: k }), Ln = fo({ typed: k }), Ts = co({ typed: k }), zs = Hi({ typed: k }), Vn = ba({ typed: k }), Os = xa({ config: br, typed: k }), Wn = Ma({ equalScalar: Ur, typed: k }), re = Ii({ typed: k }), et = La({ typed: k }), $s = ji({ typed: k }), Is = Pi({ BigNumber: oe, Fraction: He, complex: rt, typed: k }), qs = vs({ typed: k }), Pr = Ia({ Matrix: ke, equalScalar: Ur, typed: k }), se = si({ typed: k }), fe = Za({ BigNumber: oe, typed: k }), vr = ka({ DenseMatrix: Br, Matrix: ke, SparseMatrix: Pr, typed: k }), Rs = yo({ isInteger: Vn, matrix: vr, typed: k }), tt = Wi({ Complex: Me, config: br, typed: k }), Us = Co({ matrix: vr, typed: k }), Ps = Bo({ BigNumber: oe, config: br, matrix: vr, typed: k }), Xr = eo({ isInteger: Vn, matrix: vr, typed: k }), Ls = bo({ conj: Ne, transpose: Us, typed: k }), Vs = oo({ DenseMatrix: Br, SparseMatrix: Pr, matrix: vr, typed: k }), Zn = Po({ DenseMatrix: Br, SparseMatrix: Pr, concat: Xr, equalScalar: Ur, matrix: vr, typed: k }), Jn = Ka({ Fraction: He, typed: k }), nt = Do({ BigNumber: oe, DenseMatrix: Br, SparseMatrix: Pr, config: br, matrix: vr, typed: k }), Ws = ko({ DenseMatrix: Br, SparseMatrix: Pr, concat: Xr, config: br, matrix: vr, typed: k }), Zs = Mo({ bignumber: fe, fraction: Jn, number: et }), ut = Ao({ matrix: vr, config: br, typed: k }), Te = Wo({ DenseMatrix: Br, SparseMatrix: Pr, bignumber: fe, concat: Xr, config: br, matrix: vr, typed: k }), ze = ti({ typed: k }), at = ps({ DenseMatrix: Br, SparseMatrix: Pr, addScalar: jr, concat: Xr, equalScalar: Ur, matrix: vr, typed: k }), ee = To({ numeric: Zs, typed: k }), Js = ts({ DenseMatrix: Br, smaller: Te }), Qs = as({ ImmutableDenseMatrix: Js, getMatrixDataType: Ts }), it = Yo({ DenseMatrix: Br, SparseMatrix: Pr, bignumber: fe, concat: Xr, config: br, matrix: vr, typed: k }), Xs = ri({ flatten: Ln, matrix: vr, size: ut, typed: k }), Gs = Fs({ addScalar: jr, complex: rt, conj: Ne, divideScalar: ee, equal: Zn, identity: nt, isZero: Wn, matrix: vr, multiplyScalar: re, sign: Is, sqrt: tt, subtractScalar: se, typed: k, unaryMinus: ze, zeros: Ps }), Ys = Qo({ DenseMatrix: Br, SparseMatrix: Pr, concat: Xr, config: br, matrix: vr, typed: k }), Qn = Ji({ DenseMatrix: Br, concat: Xr, equalScalar: Ur, matrix: vr, subtractScalar: se, typed: k, unaryMinus: ze }), Ks = Io({ DenseMatrix: Br, divideScalar: ee, equalScalar: Ur, matrix: vr, multiplyScalar: re, subtractScalar: se, typed: k }), Xn = gs({ addScalar: jr, conj: Ne, multiplyScalar: re, size: ut, typed: k }), te = Ri({ addScalar: jr, dot: Xn, equalScalar: Ur, matrix: vr, multiplyScalar: re, typed: k }), Hs = mo({ bignumber: fe, matrix: vr, add: at, config: br, isPositive: Os, larger: it, largerEq: Ws, smaller: Te, smallerEq: Ys, typed: k }), ks = Ro({ DenseMatrix: Br, divideScalar: ee, equalScalar: Ur, matrix: vr, multiplyScalar: re, subtractScalar: se, typed: k }), js = no({ Index: Qs, matrix: vr, range: Hs, typed: k }), uf = ao({ matrix: vr, multiply: te, subtract: Qn, typed: k }), rf = Es({ divideScalar: ee, isZero: Wn, matrix: vr, multiply: te, subtractScalar: se, typed: k, unaryMinus: ze }), Gn = ws({ abs: je, addScalar: jr, det: rf, divideScalar: ee, identity: nt, matrix: vr, multiply: te, typed: k, unaryMinus: ze }), ef = Oo({ Complex: Me, config: br, fraction: Jn, identity: nt, inv: Gn, matrix: vr, multiply: te, number: et, typed: k }), tf = Ss({ abs: je, add: at, addScalar: jr, atan: Ms, bignumber: fe, column: js, complex: rt, config: br, cos: Ns, diag: Vs, divideScalar: ee, dot: Xn, equal: Zn, flatten: Ln, im: zs, inv: Gn, larger: it, matrix: vr, matrixFromColumns: Xs, multiply: te, multiplyScalar: re, number: et, qr: Gs, re: $s, reshape: Rs, sin: qs, size: ut, smaller: Te, sqrt: tt, subtract: Qn, typed: k, usolve: Ks, usolveAll: ks }), af = hs({ abs: je, add: at, conj: Ne, ctranspose: Ls, eigs: tf, equalScalar: Ur, larger: it, matrix: vr, multiply: te, pow: ef, smaller: Te, sqrt: tt, typed: k });
export {
  at as a,
  uf as c,
  af as n,
