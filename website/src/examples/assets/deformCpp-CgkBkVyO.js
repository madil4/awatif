...
let Qr;
let __tla = (async () => {
  const qr = "modulepreload", Kr = function(W, L) {
    return new URL(W, L).href;
  }, cr = {}, Jr = function(L, d, T) {
    let j = Promise.resolve();
    if (d && d.length > 0) {
      const U = document.getElementsByTagName("link"), P = document.querySelector("meta[property=csp-nonce]"), K = (P == null ? void 0 : P.nonce) || (P == null ? void 0 : P.getAttribute("nonce"));
      j = Promise.allSettled(d.map((D) => {
        if (D = Kr(D, T), D in cr) return;
        cr[D] = true;
        const B = D.endsWith(".css"), me = B ? '[rel="stylesheet"]' : "";
        if (!!T) for (let G = U.length - 1; G >= 0; G--) {
          const $ = U[G];
          if ($.href === D && (!B || $.rel === "stylesheet")) return;
        }
        else if (document.querySelector(`link[href="${D}"]${me}`)) return;
        const A = document.createElement("link");
        if (A.rel = B ? "stylesheet" : qr, B || (A.as = "script"), A.crossOrigin = "", A.href = D, K && A.setAttribute("nonce", K), document.head.appendChild(A), B) return new Promise((G, $) => {
          A.addEventListener("load", G), A.addEventListener("error", () => $(new Error(`Unable to preload CSS for ${D}`)));
        });
      }));
    }
    function _(U) {
      ...
      if (P.payload = U, window.dispatchEvent(P), !P.defaultPrevented) throw U;
    }
    return j.then((U) => {
      for (const P of U || []) P.status === "rejected" && _(P.reason);
      return L().catch(_);
    });
  };
  async function Zr(W = {}) {
    ...
    (function() {
      ...
      function e(c) {
        ...
        return f = f.map((E, g, m) => E.padStart(2, "0")), f.join("");
      }
      var r = (c) => [
        c / 1e4 | 0,
        (c / 100 | 0) % 100,
    ...
    var d = W, T = !!globalThis.window, j = !!globalThis.WorkerGlobalScope, _ = ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer", U = !T && !_ && !j;
    if (_) {
      const { createRequire: e } = await Jr(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), [], import.meta.url);
      var P = e(import.meta.url);
    }
    var K = "./this.program", D = import.meta.url, B = "";
    function me(e) {
      return d.locateFile ? d.locateFile(e, B) : B + e;
    }
    var ae, A;
    if (_) {
      ...
      var G = P("node:fs");
      D.startsWith("file:") && (B = P("node:path").dirname(P("node:url").fileURLToPath(D)) + "/"), A = (r) => {
        r = J(r) ? new URL(r) : r;
        var t = G.readFileSync(r);
        return u(Buffer.isBuffer(t)), t;
      }, ae = async (r, t = true) => {
        r = J(r) ? new URL(r) : r;
        var o = G.readFileSync(r, t ? void 0 : "utf8");
        return u(t ? Buffer.isBuffer(o) : typeof o == "string"), o;
      }, process.argv.length > 1 && (K = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2);
    } else if (!U) if (T || j) {
      try {
        B = new URL(".", D).href;
      } catch {
    ...
    var $ = console.log.bind(console), b = console.error.bind(console);
    u(!U, "shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");
    var ee;
    ...
    var J = (e) => e.startsWith("file://");
    function Se() {
      var e = Ke();
      u((e & 3) == 0), e == 0 && (e += 4), v[e >> 2] = 34821223, v[e + 4 >> 2] = 2310721022, v[0] = 1668509029;
    }
    function le() {
      if (!se) {
        var e = Ke();
        ...
        (r != 34821223 || t != 2310721022) && y(`Stack overflow! Stack cookie has been overwritten at ${R(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${R(t)} ${R(r)}`), v[0] != 1668509029 && y("Runtime error: The application has corrupted its heap memory area (address zero)!");
      }
    }
    (() => {
    ...
    function ve(e) {
      Object.getOwnPropertyDescriptor(d, e) || Object.defineProperty(d, e, {
        ...
        get() {
          ...
          ke(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), y(r);
        }
      });
    }
    var te, Ue, O, Z, ne, v, M, Q = false;
    function be() {
      var e = je.buffer;
      O = new Int8Array(e), d.HEAPU8 = Z = new Uint8Array(e), ne = new Int32Array(e), d.HEAPU32 = v = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), M = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    function Pe() {
      if (d.preRun) for (typeof d.preRun == "function" && (d.preRun = [
        d.preRun
      ]); d.preRun.length; ) $e(d.preRun.shift());
      re("preRun"), Ae(Re);
    }
    function Be() {
      u(!Q), Q = true, le(), !d.noFSInit && !n.initialized && n.init(), ye.__wasm_call_ctors(), n.ignorePermissions = false;
    }
    function ze() {
      if (le(), d.postRun) for (typeof d.postRun == "function" && (d.postRun = [
        d.postRun
      ]); d.postRun.length; ) He(d.postRun.shift());
      re("postRun"), Ae(Ne);
    }
    function y(e) {
      var _a2;
      (_a2 = d.onAbort) == null ? void 0 : _a2.call(d, e), e = "Aborted(" + e + ")", b(e), se = true;
    ...
    var he;
    function Ge() {
      return d.locateFile ? me("deform.wasm") : new URL("" + new URL("deform-DjDT8Z0y.wasm", import.meta.url).href, import.meta.url).href;
    }
    function S(e) {
      if (e == he && ee) return new Uint8Array(ee);
      if (A) return A(e);
    ...
    async function pe(e, r) {
      try {
        var t = await Y(e), o = await WebAssembly.instantiate(t, r);
        return o;
      } catch (i) {
        b(`failed to asynchronously prepare wasm: ${i}`), J(e) && b(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), y(i);
      }
    }
    ...
    async function xe() {
      function e(s, l) {
        return ye = s.exports, Yr(ye), be(), ye;
      }
      var r = d;
      function t(s) {
      ...
      he ?? (he = Ge());
      var i = await de(ee, he, o), a = t(i);
      return a;
    }
    var Ae = (e) => {
      for (; e.length > 0; ) e.shift()(d);
    }, Ne = [], He = (e) => Ne.push(e), Re = [], $e = (e) => Re.push(e), R = (e) => (u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), C = (e) => {
      C.shown || (C.shown = {}), C.shown[e] || (C.shown[e] = 1, _ && (e = "warning: " + e), b(e));
    }, Ze = globalThis.TextDecoder && new TextDecoder(), ur = (e, r, t, o) => {
      ...
      for (var a = ""; r < i; ) {
        ...
        var c = e[r++] & 63;
        if ((s & 240) == 224 ? s = (s & 15) << 12 | l << 6 | c : ((s & 248) != 240 && C("Invalid UTF-8 leading byte " + R(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | l << 12 | c << 6 | e[r++] & 63), s < 65536) a += String.fromCharCode(s);
        else {
          var f = s - 65536;
      ...
      return a;
    }, De = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? Ee(Z, e, r) : ""), fr = (e, r, t, o) => y(`Assertion failed: ${De(e)}, at: ` + [
    ...
    var vr = (e, r, t) => {
    ...
    }, hr = () => y("native code called abort()"), Qe = (e, r, t, o) => {
      ...
      for (var i = t, a = t + o - 1, s = 0; s < e.length; ++s) {
        ...
        if (l <= 127) {
          ...
          if (t + 3 >= a) break;
          l > 1114111 && C("Invalid Unicode code point " + R(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | l >> 18, r[t++] = 128 | l >> 12 & 63, r[t++] = 128 | l >> 6 & 63, r[t++] = 128 | l & 63, s++;
        }
      }
      return r[t] = 0, t - i;
    }, Oe = (e, r, t) => (u(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Qe(e, Z, r, t)), We = (e) => {
      ...
      v[e >> 2] = f * 60, ne[r >> 2] = +(l != c);
      var E = (p) => {
        var k = p >= 0 ? "-" : "+", z = Math.abs(p), x = String(Math.floor(z / 60)).padStart(2, "0"), I = String(z % 60).padStart(2, "0");
        return `UTC${k}${x}${I}`;
      }, g = E(l), m = E(c);
      u(g), u(m), u(We(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), u(We(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), c < l ? (Oe(g, t, 17), Oe(m, o, 17)) : (Oe(g, o, 17), Oe(m, t, 17));
    }, Er = () => 2147483648, _r = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), gr = (e) => {
      var r = je.buffer.byteLength, t = (e - r + 65535) / 65536 | 0;
      try {
        return je.grow(t), be(), 1;
      } catch (o) {
        b(`growMemory: Attempted to grow heap from ${r} bytes to ${e} bytes, but got error: ${o}`);
      }
    }, yr = (e) => {
      var r = Z.length;
      e >>>= 0, u(e > r);
      ...
      relative: (e, r) => {
        ...
        function t(f) {
          for (var E = 0; E < f.length && f[E] === ""; E++) ;
          for (var g = f.length - 1; g >= 0 && f[g] === ""; g--) ;
          return E > g ? [] : f.slice(E, g - E + 1);
        }
      ...
      var o = We(e) + 1, i = new Array(o), a = Qe(e, i, 0, i.length);
      return i.length = a, i;
    }, Tr = () => {
      var _a2;
      if (!Ye.length) {
...
`));
      ...
      register(e, r) {
        ue.ttys[e] = {
          ...
          output: [],
          ops: r
        }, n.registerDevice(e, ue.stream_ops);
      },
      stream_ops: {
        open(e) {
      ...
      default_tty_ops: {
        ...
        put_char(e, r) {
          r === null || r === 10 ? ($(Ee(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && ($(Ee(e.output)), e.output = []);
        },
        ioctl_tcgets(e) {
          return {
            c_iflag: 25856,
      ...
      default_tty1_ops: {
        ...
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (b(Ee(e.output)), e.output = []);
        }
      }
    }, rr = (e) => {
      ...
      createNode(e, r, t, o) {
        ...
        return n.isDir(i.mode) ? (i.node_ops = h.ops_table.dir.node, i.stream_ops = h.ops_table.dir.stream, i.contents = {}) : n.isFile(i.mode) ? (i.node_ops = h.ops_table.file.node, i.stream_ops = h.ops_table.file.stream, i.usedBytes = 0, i.contents = null) : n.isLink(i.mode) ? (i.node_ops = h.ops_table.link.node, i.stream_ops = h.ops_table.link.stream) : n.isChrdev(i.mode) && (i.node_ops = h.ops_table.chrdev.node, i.stream_ops = h.ops_table.chrdev.stream), i.atime = i.mtime = i.ctime = Date.now(), e && (e.contents[r] = i, e.atime = e.mtime = e.ctime = i.atime), i;
      },
      ...
      stream_ops: {
        ...
        write(e, r, t, o, i, a) {
          ...
          if (h.expandFileStorage(s, i + o), s.contents.subarray && r.subarray) s.contents.set(r.subarray(t, t + o), i);
        ...
        mmap(e, r, t, o, i) {
          ...
          if (!(i & 2) && l && l.buffer === O.buffer) s = false, a = l.byteOffset;
            ...
            if (s = true, a = rr(), !a) throw new n.ErrnoError(48);
    ...
    }, Nr = (...e) => n.createDataFile(...e), Rr = (e) => {
      for (var r = e; ; ) {
        if (!ge[e]) return e;
        e = r + Math.random();
      }
    }, fe = 0, Ce = null, ge = {}, ie = null, Dr = (e) => {
      var _a2;
      if (fe--, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, fe), u(e, "removeRunDependency requires an ID"), u(ge[e]), delete ge[e], fe == 0 && (ie !== null && (clearInterval(ie), ie = null), Ce)) {
        var r = Ce;
        Ce = null, r();
      }
    }, Or = (e) => {
      var _a2, _b2;
      fe++, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, fe), u(e, "addRunDependency requires an ID"), u(!ge[e]), ge[e] = 1, ie === null && globalThis.setInterval && (ie = setInterval(() => {
        if (se) {
          clearInterval(ie), ie = null;
          return;
        }
        var r = false;
        for (var t in ge) r || (r = true, b("still waiting on run dependencies:")), b(`dependency: ${t}`);
        r && b("(end of list)");
      }, 1e4), (_b2 = ie.unref) == null ? void 0 : _b2.call(ie));
    }, nr = [], Mr = async (e, r) => {
      ...
      return e;
    }, or = async (e, r, t, o, i, a, s, l) => {
      var c = r ? _e.resolve(w.join2(e, r)) : e, f = Rr(`cp ${c}`);
      Or(f);
      try {
        var E = t;
        typeof t == "string" && (E = await Ar(t)), E = await Mr(E, c), l == null ? void 0 : l(), a || Nr(e, r, E, o, i, s);
      } finally {
        Dr(f);
      }
    }, Cr = (e, r, t, o, i, a, s, l, c, f) => {
      or(e, r, t, o, i, l, c, f).then(a).catch(s);
    }, n = {
      root: null,
      mounts: [],
      devices: {},
      ...
      symlink(e, r) {
        if (!_e.resolve(e)) throw new n.ErrnoError(44);
      ...
      rename(e, r) {
        ...
        var f = n.lookupNode(l, i), E = _e.relative(e, o);
        if (E.charAt(0) !== ".") throw new n.ErrnoError(28);
        if (E = _e.relative(r, t), E.charAt(0) !== ".") throw new n.ErrnoError(55);
        var g;
        try {
          g = n.lookupNode(c, a);
        } catch {
        ...
        if (f !== g) {
          var m = n.isDir(f.mode), p = n.mayDelete(l, i, m);
          if (p) throw new n.ErrnoError(p);
          if (p = g ? n.mayDelete(c, a, m) : n.mayCreate(c, a), p) throw new n.ErrnoError(p);
          if (!l.node_ops.rename) throw new n.ErrnoError(63);
          if (n.isMountpoint(f) || g && n.isMountpoint(g)) throw new n.ErrnoError(10);
          if (c !== l && (p = n.nodePermissions(l, "w"), p)) throw new n.ErrnoError(p);
          n.hashRemoveNode(f);
          try {
      ...
      open(e, r, t = 438) {
        if (e === "") throw new n.ErrnoError(44);
        r = typeof r == "string" ? br(r) : r, r & 64 ? t = t & 4095 | 32768 : t = 0;
        var o, i;
      ...
      readFile(e, r = {}) {
        ...
        return n.read(t, a, 0, i, 0), r.encoding === "utf8" && (a = Ee(a)), n.close(t), a;
      },
      writeFile(e, r, t = {}) {
        t.flags = t.flags || 577;
        var o = n.open(e, t.flags, t.mode);
        typeof r == "string" && (r = new Uint8Array(Xe(r))), ArrayBuffer.isView(r) ? n.write(o, r, 0, r.byteLength, void 0, t.canOwn) : y("Unsupported data type"), n.close(o);
      },
      cwd: () => n.currentPath,
      chdir(e) {
        var r = n.lookupPath(e, {
      ...
      createDefaultDevices() {
        n.mkdir("/dev"), n.registerDevice(n.makedev(1, 3), {
          ...
          write: (o, i, a, s, l) => s,
          llseek: () => 0
        }), n.mkdev("/dev/null", n.makedev(1, 3)), ue.register(n.makedev(5, 0), ue.default_tty_ops), ue.register(n.makedev(6, 0), ue.default_tty1_ops), n.mkdev("/dev/tty", n.makedev(5, 0)), n.mkdev("/dev/tty1", n.makedev(6, 0));
        var e = new Uint8Array(1024), r = 0, t = () => (r === 0 && (er(e), r = e.byteLength), e[--r]);
      ...
      createFile(e, r, t, o, i) {
        var a = w.join2(typeof e == "string" ? e : n.getPath(e), r), s = qe(o, i);
        return n.create(a, s);
      },
      createDataFile(e, r, t, o, i, a) {
        var s = r;
        e && (e = typeof e == "string" ? e : n.getPath(e), s = r ? w.join2(e, r) : e);
        var l = qe(o, i), c = n.create(s, l);
        if (t) {
          if (typeof t == "string") {
            for (var f = new Array(t.length), E = 0, g = t.length; E < g; ++E) f[E] = t.charCodeAt(E);
            t = f;
          }
          n.chmod(c, l | 146);
          var m = n.open(c, 577);
      ...
      createDevice(e, r, t, o) {
        var _a2;
        var i = w.join2(typeof e == "string" ? e : n.getPath(e), r), a = qe(!!t, !!o);
        ...
        return n.registerDevice(s, {
          ...
          read(l, c, f, E, g) {
            for (var m = 0, p = 0; p < E; p++) {
              ...
              if (k === void 0 && m === 0) throw new n.ErrnoError(6);
              if (k == null) break;
              m++, c[f + p] = k;
            }
          ...
          write(l, c, f, E, g) {
            for (var m = 0; m < E; m++) try {
              o(c[f + m]);
            } catch {
              throw new n.ErrnoError(29);
            }
            return E && (l.node.mtime = l.node.ctime = Date.now()), m;
          }
        }), n.mkdev(i, a, s);
      },
      forceLoadFile(e) {
      ...
      createLazyFile(e, r, t, o, i) {
        class a {
          ...
          cacheLength() {
            ...
            var p = Number(m.getResponseHeader("Content-length")), k, z = (k = m.getResponseHeader("Accept-Ranges")) && k === "bytes", x = (k = m.getResponseHeader("Content-Encoding")) && k === "gzip", I = 1024 * 1024;
            z || (I = p);
            var X = (q, we) => {
              q > we && y("invalid range (" + q + ", " + we + ") or no bytes requested!"), we > p - 1 && y("only " + p + " bytes available! programmer error!");
              var N = new XMLHttpRequest();
              return N.open("GET", t, false), p !== I && N.setRequestHeader("Range", "bytes=" + q + "-" + we), N.responseType = "arraybuffer", N.overrideMimeType && N.overrideMimeType("text/plain; charset=x-user-defined"), N.send(null), N.status >= 200 && N.status < 300 || N.status === 304 || y("Couldn't load " + t + ". Status: " + N.status), N.response !== void 0 ? new Uint8Array(N.response || []) : Xe(N.responseText || "");
            }, Le = this;
            Le.setDataGetter((q) => {
              var we = q * I, N = (q + 1) * I - 1;
              return N = Math.min(N, p - 1), typeof Le.chunks[q] > "u" && (Le.chunks[q] = X(we, N)), typeof Le.chunks[q] > "u" && y("doXHR failed!"), Le.chunks[q];
            }), (x || !p) && (I = p = 1, p = this.getter(0).length, I = p, $("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = p, this._chunkSize = I, this.lengthKnown = true;
          }
          get length() {
        ...
        if (globalThis.XMLHttpRequest) {
          j || y("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
          var s = new a(), l = {
            isDevice: false,
            contents: s
          };
        ...
        var f = {};
        for (const [g, m] of Object.entries(c.stream_ops)) f[g] = (...p) => (n.forceLoadFile(c), m(...p));
        function E(g, m, p, k, z) {
          var x = g.node.contents;
          if (z >= x.length) return 0;
          var I = Math.min(x.length - z, k);
          if (u(I >= 0), x.slice) for (var X = 0; X < I; X++) m[p + X] = x[z + X];
          else for (var X = 0; X < I; X++) m[p + X] = x.get(z + X);
          return I;
        }
        return f.read = (g, m, p, k, z) => (n.forceLoadFile(c), E(g, m, p, k, z)), f.mmap = (g, m, p, k, z) => {
          n.forceLoadFile(c);
          var x = rr();
      ...
      writeStat(e, r) {
        v[e >> 2] = r.dev, v[e + 4 >> 2] = r.mode, v[e + 8 >> 2] = r.nlink, v[e + 12 >> 2] = r.uid, v[e + 16 >> 2] = r.gid, v[e + 20 >> 2] = r.rdev, M[e + 24 >> 3] = BigInt(r.size), ne[e + 32 >> 2] = 4096, ne[e + 36 >> 2] = r.blocks;
        var t = r.atime.getTime(), o = r.mtime.getTime(), i = r.ctime.getTime();
        return M[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), v[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, M[e + 56 >> 3] = BigInt(Math.floor(o / 1e3)), v[e + 64 >> 2] = o % 1e3 * 1e3 * 1e3, M[e + 72 >> 3] = BigInt(Math.floor(i / 1e3)), v[e + 80 >> 2] = i % 1e3 * 1e3 * 1e3, M[e + 88 >> 3] = BigInt(r.ino), 0;
      },
      writeStatFs(e, r) {
    ...
    function Ur(e, r, t, o) {
      try {
        var i = Ie.getStreamFromFD(e), a = Lr(i, r, t);
        return v[o >> 2] = a, 0;
      } catch (s) {
    ...
    var Br = 9007199254740992, zr = -9007199254740992, xr = (e) => e < zr || e > Br ? NaN : Number(e);
    function Hr(e, r, t, o) {
      r = xr(r);
      try {
        if (isNaN(r)) return 61;
        var i = Ie.getStreamFromFD(e);
        return n.llseek(i, r, t), M[o >> 3] = BigInt(i.position), i.getdents && r === 0 && t === 0 && (i.getdents = null), 0;
      } catch (a) {
    ...
    function jr(e, r, t, o) {
      try {
        var i = Ie.getStreamFromFD(e), a = Wr(i, r, t);
        return v[o >> 2] = a, 0;
      } catch (s) {
        if (typeof n > "u" || s.name !== "ErrnoError") throw s;
        return s.errno;
    ...
    d._deform = V("_deform"), d._free = V("_free"), d._malloc = V("_malloc");
    var ir = V("_fflush"), ar = V("_strerror"), Ke = V("_emscripten_stack_get_end"), sr = V("_emscripten_stack_init"), je = V("wasmMemory");
    function Yr(e) {
      u(typeof e.deform < "u", "missing Wasm export: deform"), u(typeof e.free < "u", "missing Wasm export: free"), u(typeof e.malloc < "u", "missing Wasm export: malloc"), u(typeof e.fflush < "u", "missing Wasm export: fflush"), u(typeof e.strerror < "u", "missing Wasm export: strerror"), u(typeof e.emscripten_stack_get_end < "u", "missing Wasm export: emscripten_stack_get_end"), u(typeof e.emscripten_stack_get_base < "u", "missing Wasm export: emscripten_stack_get_base"), u(typeof e.emscripten_stack_init < "u", "missing Wasm export: emscripten_stack_init"), u(typeof e.emscripten_stack_get_free < "u", "missing Wasm export: emscripten_stack_get_free"), u(typeof e._emscripten_stack_restore < "u", "missing Wasm export: _emscripten_stack_restore"), u(typeof e._emscripten_stack_alloc < "u", "missing Wasm export: _emscripten_stack_alloc"), u(typeof e.emscripten_stack_get_current < "u", "missing Wasm export: emscripten_stack_get_current"), u(typeof e.memory < "u", "missing Wasm export: memory"), u(typeof e.__indirect_function_table < "u", "missing Wasm export: __indirect_function_table"), d._deform = oe("deform", 49), d._free = oe("free", 1), d._malloc = oe("malloc", 1), ir = oe("fflush", 1), ar = oe("strerror", 1), Ke = e.emscripten_stack_get_end, e.emscripten_stack_get_base, sr = e.emscripten_stack_init, e.emscripten_stack_get_free, e._emscripten_stack_restore, e._emscripten_stack_alloc, e.emscripten_stack_get_current, je = e.memory, e.__indirect_function_table;
    }
    var lr = {
      __assert_fail: fr,
      __cxa_throw: vr,
    ...
    function Je() {
      ...
      function e() {
        var _a2;
        u(!dr), dr = true, d.calledRun = true, !se && (Be(), te == null ? void 0 : te(d), (_a2 = d.onRuntimeInitialized) == null ? void 0 : _a2.call(d), re("onRuntimeInitialized"), u(!d._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), ze());
      }
    ...
    var ye;
    ye = await xe(), Je(), Q ? L = d : L = new Promise((e, r) => {
      te = e, Ue = r;
    });
    for (const e of Object.keys(d)) e in W || Object.defineProperty(W, e, {
      configurable: true,
      get() {
  ...
  const F = await Zr();
  Qr = function(W, L, d, T, j) {
    if (W.length === 0) return;
    const _ = [], U = H(W.flat(), Float64Array, F.HEAPF64);
    _.push(U);
    const P = L.flat(), K = H(P, Uint32Array, F.HEAPU32);
    _.push(K);
    const D = L.map((S) => S.length), B = H(D, Uint32Array, F.HEAPU32);
    _.push(B);
    const me = d.supports ? Array.from(d.supports.keys()) : [], ae = d.supports ? Array.from(d.supports.values()).flat().map((S) => S ? 1 : 0) : [], A = H(me, Uint32Array, F.HEAPU32);
    _.push(A);
    const G = H(ae, Uint8Array, F.HEAPU8);
    _.push(G);
    const $ = d.loads ? Array.from(d.loads.keys()) : [], b = d.loads ? Array.from(d.loads.values()).flat() : [], ee = H($, Uint32Array, F.HEAPU32);
    _.push(ee);
    const se = H(b, Float64Array, F.HEAPF64);
    _.push(se);
    const u = (S) => {
      const Y = S ? Array.from(S.keys()) : [], pe = S ? Array.from(S.values()) : [], de = H(Y, Uint32Array, F.HEAPU32);
      _.push(de);
      const ce = H(pe, Float64Array, F.HEAPF64);
      return _.push(ce), {
        keysPtr: de,
        valuesPtr: ce,
        size: Y.length
      };
    }, J = u(T.elasticities), Se = u(T.elasticitiesOrthogonal), le = u(T.areas), re = u(T.momentsOfInertiaZ), V = u(T.momentsOfInertiaY), Fe = u(T.shearModuli), ke = u(T.torsionalConstants), Te = u(T.thicknesses), ve = u(T.poissonsRatios), te = Ge(T.cltLayups), Ue = (j == null ? void 0 : j.includeReactions) ?? true, O = F._malloc(4);
    _.push(O);
    const Z = F._malloc(4);
    _.push(Z);
    const ne = F._malloc(4);
    _.push(ne);
    const v = F._malloc(4);
    _.push(v);
    const M = F._deform;
    M(U, W.length, K, P.length, B, L.length, A, G, me.length, ee, se, $.length, J.keysPtr, J.valuesPtr, J.size, le.keysPtr, le.valuesPtr, le.size, re.keysPtr, re.valuesPtr, re.size, V.keysPtr, V.valuesPtr, V.size, Fe.keysPtr, Fe.valuesPtr, Fe.size, ke.keysPtr, ke.valuesPtr, ke.size, Te.keysPtr, Te.valuesPtr, Te.size, ve.keysPtr, ve.valuesPtr, ve.size, Se.keysPtr, Se.valuesPtr, Se.size, te.keysPtr, te.layerCountsPtr, te.optionsPtr, te.layersFlatPtr, te.size, Ue ? 1 : 0, O, Z, ne, v);
    const Q = F.HEAPU32[O / 4], be = F.HEAPU32[Z / 4], Pe = F.HEAPU32[ne / 4], Be = F.HEAPU32[v / 4], ze = new Float64Array(F.HEAPF64.buffer, Q, be), y = new Float64Array(F.HEAPF64.buffer, Pe, Be), oe = /* @__PURE__ */ new Map();
    for (let S = 0; S < be; S += 7) {
      const Y = ze[S];
      oe.set(Y, Array.from(ze.slice(S + 1, S + 7)));
    }
    const he = /* @__PURE__ */ new Map();
    for (let S = 0; S < Be; S += 7) {
      const Y = y[S];
      he.set(Y, Array.from(y.slice(S + 1, S + 7)));
    }
    return Q && _.push(Q), Pe && _.push(Pe), _.forEach((S) => F._free(S)), {
      deformations: oe,
      reactions: he
    };
    function Ge(S) {
      const Y = S ? Array.from(S.entries()) : [], pe = [], de = [], ce = [], xe = [];
      for (const [$e, R] of Y) {
        pe.push($e), de.push(R.layers.length), ce.push(R.options.shearCoupling ? 1 : 0, R.options.noGlueAtNarrowSide ? 1 : 0, R.options.strictSymmetryForElement ?? true ? 1 : 0, R.options.symmetryTolerance ?? 1e-6, R.options.r33 ?? 1, R.options.r66 ?? 1, R.options.r77 ?? 1, R.options.r88 ?? 1);
        for (const C of R.layers) xe.push(C.thickness, C.thetaDeg, C.Ex, C.Ey, C.nuXY, C.Gxy, C.Gxz, C.Gyz);
      }
      const Ae = H(pe, Uint32Array, F.HEAPU32);
      _.push(Ae);
      const Ne = H(de, Uint32Array, F.HEAPU32);
      _.push(Ne);
      const He = H(ce, Float64Array, F.HEAPF64);
      _.push(He);
      const Re = H(xe, Float64Array, F.HEAPF64);
      return _.push(Re), {
        keysPtr: Ae,
        layerCountsPtr: Ne,
        optionsPtr: He,
  ...
  function H(W, L, d) {
    const T = new L(W), j = F._malloc(T.length * T.BYTES_PER_ELEMENT);
    return d.set(T, j / T.BYTES_PER_ELEMENT), j;
  }
})();
export {
  __tla,
