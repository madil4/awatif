import { _ as me, t as ie, D as nt, C as Fr, __tla as __tla_0 } from "./getMesh-Bm83U438.js";
let je, ks, js, Vr, rf, Ln;
...
`);
  ...
  var vn = function() {
    ...
    return f.clear(), f.addTypes([
      ...
      if ([
        "wrongType",
        "mismatch"
      ].includes(i.data.category) && v.length === 1 && se(v[0]) && l.some((d) => !d.params.includes(","))) {
  ...
  var Pu = "BigNumber", Lu = [
    ...
    var { on: e, config: n } = r, u = nt.clone({
    ...
    isClass: true
  }), Zu = "Complex", Ju = [], Wu = J(Zu, Ju, () => (Object.defineProperty(Fr, "name", {
    value: "Complex"
    ...
    switch (arguments.length) {
      ...
      case 2: {
        ...
        if (fr(n)) {
          if (tn(u) && u.hasBase("ANGLE") && (u = u.toNumber("rad")), fr(u)) return new Fr({
            r: n,
            phi: u
          });
  ...
  var Hu = "Fraction", ku = [], ju = J(Hu, ku, () => (Object.defineProperty(Er, "name", {
    value: "Fraction"
  ...
  function Ne(r, e, n, u) {
    ...
    if (r.length = p, n < e.length - 1) {
      var l = n + 1;
      for (t = 0; t < v; t++) a = r[t], Array.isArray(a) || (a = [
        a
      ], r[t] = a), Ne(a, e, l, u);
  ...
  var Da = "DenseMatrix", pa = [
    ...
    n.prototype.clone = function() {
      ...
      var s = this, d = s.size();
      if (d.length === 1) {
        for (var c = 0; c < d[0]; c++) i(s._data, c, [
          c
        ]);
        return;
      }
  ...
  var dt = "isPositive", ya = [
    "typed",
    "config"
  ], Aa = J(dt, ya, (r) => {
    var { typed: e, config: n } = r;
    return e(dt, {
      number: (u) => $r(u, 0, n.relTol, n.absTol) ? false : xn(u),
  ...
  var _a = "SparseMatrix", Ba = [
    ...
    t.prototype.get = function(o) {
      ...
      Mr(this._datatype) && (A = e.find(n, [
        this._datatype,
        this._datatype
      ]) || n, C = e.convert(0, this._datatype)), (w > b - 1 || y > F - 1) && (d(this, Math.max(w + 1, b), Math.max(y + 1, F), g), b = this._size[0], F = this._size[1]), mr(w, b), mr(y, F);
...
`, b = 0; b < g; b++) for (var F = this._ptr[b], A = this._ptr[b + 1], C = F; C < A; C++) {
  ...
  var za = J(Sa, Ma, (r) => {
    ...
    return function(t, a, f, p) {
      ...
      typeof d == "string" && (o = d, h = e.find(n, [
        o,
        o
      ]), g = e.convert(0, o), a = e.convert(a, o), w = e.find(f, [
        o,
        o
      ]));
    ...
    return function(t, a, f, p) {
      ...
      typeof d == "string" && (o = d, a = e.convert(a, o), h = e.find(f, [
        o,
        o
      ]));
    ...
    return function(t, a, f, p) {
      ...
      typeof i == "string" && (s = i, a = e.convert(a, s), d = e.find(f, [
        s,
        s
      ]));
    ...
    return function(u, t, a, f) {
      ...
      typeof l == "string" && l === D && l !== "mixed" && (g = l, w = e.convert(0, g), y = e.find(a, [
        g,
        g
      ]));
      ...
      return u.createDenseMatrix({
        ...
        datatype: l === u._datatype && D === t._datatype ? g : void 0
      });
    };
  }), fi = "matAlgo05xSfSf", vi = [
    "typed",
    "equalScalar"
  ], li = J(fi, vi, (r) => {
    var { typed: e, equalScalar: n } = r;
    ...
    return function(t, a, f) {
      ...
      var o, h = f;
      typeof l == "string" && l === d && (o = l, h = e.find(f, [
        o,
        o
      ]));
  ...
  var hi = "matrixAlgorithmSuite", mi = [
    "typed",
    "matrix"
  ], Ur = J(hi, mi, (r) => {
    var { typed: e, matrix: n } = r, u = pi({
      typed: e
    }), t = Ze({
      typed: e
    });
    return function(f) {
      ...
      p ? (l = {
        "DenseMatrix, DenseMatrix": (c, D) => u(...yr(c, D), p),
        "Array, Array": (c, D) => u(...yr(n(c), n(D)), p).valueOf(),
        "Array, DenseMatrix": (c, D) => u(...yr(n(c), D), p),
        "DenseMatrix, Array": (c, D) => u(...yr(c, n(D)), p)
      }, f.SS && (l["SparseMatrix, SparseMatrix"] = (c, D) => f.SS(...yr(c, D), p, false)), f.DS && (l["DenseMatrix, SparseMatrix"] = (c, D) => f.DS(...yr(c, D), p, false), l["Array, SparseMatrix"] = (c, D) => f.DS(...yr(n(c), D), p, false)), v && (l["SparseMatrix, DenseMatrix"] = (c, D) => v(...yr(D, c), p, true), l["SparseMatrix, Array"] = (c, D) => v(...yr(n(D), c), p, true))) : (l = {
        "DenseMatrix, DenseMatrix": e.referToSelf((c) => (D, o) => u(...yr(D, o), c)),
        "Array, Array": e.referToSelf((c) => (D, o) => u(...yr(n(D), n(o)), c).valueOf()),
        "Array, DenseMatrix": e.referToSelf((c) => (D, o) => u(...yr(n(D), o), c)),
        "DenseMatrix, Array": e.referToSelf((c) => (D, o) => u(...yr(D, n(o)), c))
      }, f.SS && (l["SparseMatrix, SparseMatrix"] = e.referToSelf((c) => (D, o) => f.SS(...yr(D, o), c, false))), f.DS && (l["DenseMatrix, SparseMatrix"] = e.referToSelf((c) => (D, o) => f.DS(...yr(D, o), c, false)), l["Array, SparseMatrix"] = e.referToSelf((c) => (D, o) => f.DS(...yr(n(D), o), c, false))), v && (l["SparseMatrix, DenseMatrix"] = e.referToSelf((c) => (D, o) => v(...yr(o, D), c, true)), l["SparseMatrix, Array"] = e.referToSelf((c) => (D, o) => v(...yr(n(o), D), c, true))));
    ...
    return function(u, t, a, f) {
      ...
      if (v[0] !== c[0] || v[1] !== c[1]) throw new RangeError("Dimension mismatch. Matrix A (" + v + ") must match Matrix B (" + c + ")");
      if (!i) throw new Error("Cannot perform operation on Dense Matrix and Pattern Sparse Matrix");
      var o = v[0], h = v[1], g = typeof l == "string" && l !== "mixed" && l === D ? l : void 0, w = g ? e.find(a, [
        g,
        g
      ]) : a, y, b, F = [];
      for (y = 0; y < o; y++) F[y] = [];
    ...
    var { typed: e, matrix: n, addScalar: u, multiplyScalar: t, equalScalar: a, dot: f } = r, p = Sn({
      typed: e,
      equalScalar: a
    }), v = Ze({
      typed: e
    ...
    function o(F, A) {
      ...
      m && B && m === B && typeof m == "string" && m !== "mixed" && (S = m, O = e.find(u, [
        S,
        S
      ]), M = e.find(t, [
        S,
      ...
      return F.createDenseMatrix({
        ...
        datatype: m === F._datatype && B === A._datatype ? S : void 0
      });
    }
    function h(F, A) {
    ...
    function g(F, A) {
      ...
      for (var z = [], I = [], W = [], X = A.createSparseMatrix({
        values: z,
        index: I,
        ptr: W,
        size: [
    ...
    function w(F, A) {
      ...
      _ && x && _ === x && typeof _ == "string" && _ !== "mixed" && (T = _, $ = e.find(u, [
        T,
        T
      ]), Q = e.find(t, [
        T,
      ...
      return R[1] = M.length, F.createSparseMatrix({
        ...
        datatype: _ === F._datatype && x === A._datatype ? T : void 0
      });
    }
    function y(F, A) {
      var C = F._values, E = F._index, m = F._ptr, _ = F._datatype || F._data === void 0 ? F._datatype : F.getDataType();
      ...
      _ && x && _ === x && typeof _ == "string" && _ !== "mixed" && (M = _, R = e.find(u, [
        M,
        M
      ]), T = e.find(t, [
        M,
      ...
      for (var G = [], z = [], I = [], W = F.createSparseMatrix({
        values: G,
        index: z,
        ptr: I,
        size: [
        ...
        datatype: _ === F._datatype && x === A._datatype ? M : void 0
      }), X = [], V = [], q = 0; q < O; q++) {
        I[q] = z.length;
    ...
    function b(F, A) {
      ...
      _ && S && _ === S && typeof _ == "string" && _ !== "mixed" && (T = _, $ = e.find(u, [
        T,
        T
      ]), Q = e.find(t, [
        T,
      ...
      for (var G = R ? [] : void 0, z = [], I = [], W = F.createSparseMatrix({
        values: G,
        index: z,
        ptr: I,
        size: [
        ...
        datatype: _ === F._datatype && S === A._datatype ? T : void 0
      }), X = R ? [] : void 0, V = [], q, Z, P, U, Y, L, k, j, rr = 0; rr < M; rr++) {
        I[rr] = z.length;
        var er = rr + 1;
    ...
    return e(wt, t, {
      "Array, Array": e.referTo("Matrix, Matrix", (F) => (A, C) => {
        l(ir(A), ir(C));
        var E = F(n(A), n(C));
      ...
      "Matrix, Array": e.referTo("Matrix,Matrix", (F) => (A, C) => F(A, n(C))),
      "Array, Matrix": e.referToSelf((F) => (A, C) => F(n(A, C.storage()), C)),
      "SparseMatrix, any": function(A, C) {
      ...
      "any, any": t,
      "any, any, ...any": e.referToSelf((F) => (A, C, E) => {
    ...
    return e(Ct, {
      ...
      "Array | Matrix": e.referToSelf((a) => (f) => Cr(f, a)),
    ...
    var { typed: e, matrix: n, equalScalar: u, subtractScalar: t, unaryMinus: a, DenseMatrix: f, concat: p } = r, v = Mn({
      typed: e
    }), l = Xr({
      typed: e
    }), i = li({
    ...
    return function(a, f, p) {
      ...
      typeof l == "string" && l === s && l !== "mixed" && (D = l, o = e.convert(0, D), h = e.find(p, [
        D,
        D
      ]));
      var g, w, y = [];
      ...
      return new n({
        ...
        datatype: l === a._datatype && s === f._datatype ? D : void 0
      });
    };
    ...
    function a(f, p) {
      ...
      var s = [
        u(t(f[1], p[2]), t(f[2], p[1])),
        u(t(f[2], p[0]), t(f[0], p[2])),
        u(t(f[0], p[1]), t(f[1], p[0]))
      ];
      return v > 1 ? [
        s
      ] : s;
    ...
    function v(l, i, s) {
      ...
      var c = d ? new t(1) : 1, D = d ? new d(0) : 0, o = [
        l,
        i
      ];
      if (s) {
  ...
  var Jt = "usolve", _o = [
    ...
    var { typed: e, matrix: n, divideScalar: u, multiplyScalar: t, subtractScalar: a, equalScalar: f, DenseMatrix: p } = r, v = On({
      DenseMatrix: p
    });
    return e(Jt, {
    ...
    function l(s, d) {
      for (var c = [
        v(s, d, true)._data.map((E) => E[0])
      ], D = s._data, o = s._size[0], h = s._size[1], g = h - 1; g >= 0; g--) for (var w = c.length, y = 0; y < w; y++) {
        var b = c[y];
    ...
    function i(s, d) {
      for (var c = [
        v(s, d, true)._data.map((G) => G[0])
      ], D = s._size[0], o = s._size[1], h = s._values, g = s._index, w = s._ptr, y = o - 1; y >= 0; y--) for (var b = c.length, F = 0; F < b; F++) {
    ...
    var { typed: e, matrix: n, equalScalar: u, DenseMatrix: t, concat: a } = r, f = Xr({
      typed: e
    }), p = kr({
      typed: e,
      DenseMatrix: t
    ...
    var { typed: e, config: n, matrix: u, DenseMatrix: t, concat: a } = r, f = Xr({
      typed: e
    }), p = kr({
      typed: e,
      DenseMatrix: t
    ...
    function u(a) {
      ...
      for (var f = 0, p = arguments.length; f < p; f++) {
        ...
        } else if (typeof v == "number") this._dimensions.push(t([
          v
        ]));
  ...
  var Ho = "atan", ko = [
    ...
    var { typed: e, matrix: n, addScalar: u, equalScalar: t, DenseMatrix: a, SparseMatrix: f, concat: p } = r, v = Mn({
      typed: e
    }), l = Ei({
      typed: e,
      equalScalar: t
    ...
    return e(Yt, {
      "any, any": u,
      "any, any, ...any": e.referToSelf((d) => (c, D, o) => {
    ...
    function h(y) {
      var b = y._size[0], F = y._size[1], A = t([
        b
      ], "dense"), C = A._data, E = y.clone(), m = E._data, _, B, x, N = u([
        b
      ], "");
...
R: ` + this.R.toString();
  ...
  function hs(r) {
    ...
    function _(z, I, W, X, V) {
      ...
      for (var U = tr(z), Y = [], L = I, k = [], j = V ? i(Array(I).fill(P)) : void 0, rr = V ? i(Array(L).fill(P)) : void 0, er = 0; er <= 100; ) {
        ...
        if (V && (rr = t(rr, dr)), L === 1 || b(v(U[L - 1][L - 2]), W)) {
          er = 0, Y.push(U[L - 1][L - 1]), V && (k.unshift([
            [
              1
            ]
          ]), S(rr, I), j = t(j, rr), L > 1 && (rr = i(Array(L - 1).fill(P)))), L -= 1, U.pop();
    ...
    function B(z, I, W, X, V, q, Z) {
      ...
      for (var dr = [], sr = rr.length, vr = Array(I).fill(k), _r = i(Array(I).fill(j)), Br = function() {
        ...
        var Zn = t(c(X), W);
        zr = zr.map((Be) => t(Zn, Be)), dr.push(...zr.map((Be) => ({
          value: Sr,
          vector: u(Be)
        })));
      }, Ar = 0; Ar < sr; Ar++) Br();
  ...
  function ms(r) {
    ...
    function A(m) {
      for (var _ = m.length, B = 0, x = [
        0,
        1
      ], N = 0; N < _; N++) for (var S = N + 1; S < _; S++) Math.abs(B) < Math.abs(m[N][S]) && (B = Math.abs(m[N][S]), x = [
        N,
        S
      ]);
      return [
    ...
    function C(m) {
      for (var _ = m.length, B = 0, x = [
        0,
        1
      ], N = 0; N < _; N++) for (var S = N + 1; S < _; S++) t(B) < t(m[N][S]) && (B = t(m[N][S]), x = [
        N,
        S
      ]);
      return [
  ...
  let gs, ys, As, Fs, Es, ws, jr, Ee, Je, We, br, H, Qe, Gr, Cs, Xe, we, bs, Tr, In, _s, Bs, qn, xs, Rn, Yr, Ge, Ss, Ms, Ns, Ce, re, Ye, Ke, be, Un, or, Ts, zs, He, Os, $s, Pr, Is, qs, Lr, Pn, ke, Rs, Us, Ps, _e, Ls, Vn, Vs, Zs, rt, Js, Ws, Qs, Xs, Gs, et, Ys, Ks;
  gs = "eigs";
  ys = [
    "config",
    "typed",
  ...
  As = J(gs, ys, (r) => {
    var { config: e, typed: n, matrix: u, addScalar: t, subtract: a, equal: f, abs: p, atan: v, cos: l, sin: i, multiplyScalar: s, divideScalar: d, inv: c, bignumber: D, multiply: o, add: h, larger: g, column: w, flatten: y, number: b, complex: F, sqrt: A, diag: C, size: E, reshape: m, qr: _, usolve: B, usolveAll: x, im: N, re: S, smaller: O, matrixFromColumns: M, dot: R } = r, T = ms({
      config: e,
      addScalar: t,
      subtract: a,
      abs: p,
  ...
  ws = J(Fs, Es, (r) => {
    var { typed: e, matrix: n, multiply: u, equalScalar: t, divideScalar: a, inv: f } = r, p = Sn({
      typed: e,
      equalScalar: t
    }), v = Ze({
      typed: e
  ...
  Zs = Ko({
    ImmutableDenseMatrix: Vs,
    getMatrixDataType: _s
  });
  rt = Po({
    DenseMatrix: br,
    concat: Pr,
