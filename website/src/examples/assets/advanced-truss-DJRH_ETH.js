import { v as o, g as pe, a as re } from "./styles-aHt-Mdxa.js";
import { a as ue, __tla as __tla_0 } from "./analyze-DDDIG0wq.js";
import { d as de, __tla as __tla_1 } from "./deform-C3_9Anee.js";
import { g as ce } from "./getParameters-DjGKBsKO.js";
Promise.all([
  (() => {
    try {
      return __tla_0;
  ...
  o.derive(() => {
    ...
    if (t = l / Math.round(l / t), Math.abs(v - 0.5 * (g + m)) > 0.3 || Math.abs(n - 0.5 * (c + d)) > 0.3) {
      ...
      const a = Math.round((l - 2 * t) / t), i = f >= 2 && a >= 1, A = (g - v) / l, C = g - A * t, x = (c - n) / l, k = c - x * t, { nodes: O, elements: K, topNodesIndices: P, chordsIndices: le, websIndices: ne } = V(i ? l - t : l, t, u, i ? C : g, v, i ? k : c, n, i ? t : 0);
      ...
      const a = Math.round((l - 2 * t) / t), i = f >= 2 && a >= 1, A = (g - m) / l, C = (c - d) / l, { nodes: x, elements: k, topNodesIndices: O, chordsIndices: K, websIndices: P } = V(i ? l - 2 * t : l, t, u, i ? g - A * t : g, i ? m + A * t : m, i ? c - C * t : c, i ? d + C * t : d, i ? t : 0);
