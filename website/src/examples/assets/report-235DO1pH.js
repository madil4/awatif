import{v as e,e as w,x as l,a as $,g as x}from"./styles-Di8iHUIQ.js";import{a as y}from"./analyze-Cz_6MS8_.js";import{d as z}from"./deform-BXcomLjS.js";import{g as T}from"./getParameters-8K4Z7dx4.js";import{g as S}from"./getDialog-BJeKnhN2.js";function F({template:i,data:n}){const s=document.createElement("div");return e.derive(()=>{w(i(n),s)}),s}function B({nodes:i,nodeInputs:n,elementInputs:s,deformOutputs:g,analyzeOutputs:f}){return l`
    <br />
    <header class="header">
    ...
    <br /><br /><br />
  `}const r={xPosition:{value:e.state(600),min:0,max:1e3},zPosition:{value:e.state(0),min:0,max:500}},o=e.state([]),d=e.state([]),v=e.state({}),c=e.state({}),h=e.state({}),m=e.state({}),u={nodes:o,elements:d,nodeInputs:v,elementInputs:c,deformOutputs:h,analyzeOutputs:m};e.derive(()=>{o.val=[[250,0,0],[r.xPosition.value.val,0,r.zPosition.value.val],[250,0,400]],d.val=[[0,1],[1,2]],v.val={supports:new Map([[0,[!0,!0,!0,!0,!0,!0]],[2,[!0,!0,!0,!0,!0,!0]]]),loads:new Map([[1,[0,0,-1e3,0,0,0]]])},c.val={elasticities:new Map([[0,200],[1,200]]),areas:new Map([[0,100],[1,100]])},h.val=z(o.val,d.val,v.val,c.val),m.val=y(o.val,d.val,c.val,h.val)});const p=e.state(""),b=e.state(void 0);e.derive(()=>{p.val==="Report"&&(b.val=F({template:B,data:u}))});document.body.append($({clickedButton:p,buttons:["Report"],sourceCode:"https://github.com/madil4/awatif/blob/main/examples/src/report/main.ts",author:"https://www.linkedin.com/in/cal-mense/"}),S({dialogBody:b}),T(r),x({structure:u,settingsObj:{gridSize:1e3}}));
