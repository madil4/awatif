import { v as a, g as pe, a as re } from "./styles-BHEEcEe8.js";
import { a as ue } from "./analyze-y02jKfMs.js";
import { d as de, __tla as __tla_0 } from "./deformCpp-wF9UoRJI.js";
import { g as me } from "./getParameters-DUGbK7gy.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    if (t = l / Math.round(l / t), Math.abs(v - 0.5 * (g + c)) > 0.3 || Math.abs(n - 0.5 * (m + d)) > 0.3) {
      ...
      const o = Math.round((l - 2 * t) / t), h = f >= 2 && o >= 1, W = (g - v) / l, A = g - W * t, x = (m - n) / l, k = m - x * t, { nodes: O, elements: K, topNodesIndices: P, chordsIndices: le, websIndices: ne } = V(h ? l - t : l, t, u, h ? A : g, v, h ? k : m, n, h ? t : 0);
      ...
      const o = Math.round((l - 2 * t) / t), h = f >= 2 && o >= 1, W = (g - c) / l, A = (m - d) / l, { nodes: x, elements: k, topNodesIndices: O, chordsIndices: K, websIndices: P } = V(h ? l - 2 * t : l, t, u, h ? g - W * t : g, h ? c + W * t : c, h ? m - A * t : m, h ? d + A * t : d, h ? t : 0);
